...
FOG_DECLARE_TYPEINFO(Fog::Time, Fog::PrimitiveType)
FOG_DECLARE_TYPEINFO(Fog::TimeDelta, Fog::PrimitiveType)
FOG_DECLARE_TYPEINFO(Fog::TimeTicks, Fog::PrimitiveType)
