...
struct FOG_API EventLoopImpl
{
  ...
  List<EventLoopPendingTask> incomingQueue;

  //! @brief List of event observers.
  EventLoopObserverList<EventLoopObserver> observerList;
