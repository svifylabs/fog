...
#include <Fog/Core/Kernel/ListenerList.h>
...
_FOG_TYPE_DECLARE(Fog::EventLoopPendingTask, Fog::TYPE_CATEGORY_SIMPLE)
...
struct FOG_API EventLoop
{
  ...
  FOG_INLINE const StringW& getType() const { return _type; }
...
{
  WinEventLoop(const StringW& type);
