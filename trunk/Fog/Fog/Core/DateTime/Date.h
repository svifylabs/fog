...
// [Guard]
#ifndef _FOG_CORE_DATETIME_DATE_H
#define _FOG_CORE_DATETIME_DATE_H
...
_FOG_TYPEINFO_DECLARE(Fog::Date, Fog::TYPEINFO_PRIMITIVE)

// [Guard]
#endif // _FOG_CORE_DATETIME_DATE_H
