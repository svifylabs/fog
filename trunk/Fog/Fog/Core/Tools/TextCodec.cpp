...
struct FOG_NO_EXPORT NullCodec : public TextCodec::Engine
{
...
struct FOG_NO_EXPORT _8BitCodec : public TextCodec::Engine
{
...
static TextCodec::Engine* _8BitCodec_create(uint32_t code, uint32_t flags, const char* mime, void* table)
{
  ...
  for (i = 0; i < 256; i++)
  {
    ...
    if (decode == &_8BitCodec_emptyDecoder)
    {
      ...
      if (page8->decode[ucPage] == NULL) goto _Fail;
    }
...
struct FOG_NO_EXPORT UTF8Codec : public TextCodec::Engine
{
...
_SurrogateTrail:
    ...
    if (remain < 4)
    {
      ...
      if ((err = dst.grow((sysuint_t)(srcEnd - srcCur) * 3 + 4))) goto _End;
...
struct FOG_NO_EXPORT UTF16Codec : public TextCodec::Engine
{
...
struct FOG_NO_EXPORT UCS2Codec : public TextCodec::Engine
{
...
_SurrogateTrail:
...

      {
        ...
        sysuint_t dl;
        sysuint_t rl;
        if ((err = replacer(replaceBuffer, uc))) goto _End;
...
struct FOG_NO_EXPORT UTF32Codec : public TextCodec::Engine
{
...
static const char* getCodeset(void)
{
  ...
  {
    Debug::dbgFunc("Fog::TextCodec", "getCodesetPrivate", "Can't get system codeset.\n");
...
static TextCodec::Engine* getEngine(uint32_t code)
{
  ...
  if (v != NULL && v != (TextCodec::Engine*)CREATING_NOW) goto _Ret;
