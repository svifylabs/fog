...
FOG_DECLARE_TYPEINFO(Fog::Str8       , Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::Ascii8     , Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::Local8     , Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::Utf8       , Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::Utf16      , Fog::TYPE_INFO_PRIMITIVE)

FOG_DECLARE_TYPEINFO(Fog::FormatFlags, Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::Range      , Fog::TYPE_INFO_PRIMITIVE)
