...
FOG_NO_EXPORT void MemDebug_init(void)
{
  ...
  _api.memmgr._m_alloc = MemMgr_alloc_debug;
  _api.memmgr._m_calloc = MemMgr_calloc_debug;
  _api.memmgr._m_realloc = MemMgr_realloc_debug;
  _api.memmgr._m_free = MemMgr_free_debug;
}
