...
// [Guard]
#ifndef _FOG_CORE_FACE_FACE_C_P64_H
...
static FOG_INLINE void p64Load2aNative(p64& dst0, const void* srcp) { dst0 = ((const uint16_t*)srcp)[0]; }
static FOG_INLINE void p64Load2uNative(p64& dst0, const void* srcp) { dst0 = ((const uint16_t*)srcp)[0]; }

static FOG_INLINE void p64Load2aSwap(p64& dst0, const void* srcp) { dst0 = Memory::bswap16( ((const uint16_t*)srcp)[0] ); }
static FOG_INLINE void p64Load2uSwap(p64& dst0, const void* srcp) { dst0 = Memory::bswap16( ((const uint16_t*)srcp)[0] ); }

static FOG_INLINE void p64Store2aNative(void* dstp, const p64& src0) { ((uint16_t*)dstp)[0] = (uint16_t)src0; }
static FOG_INLINE void p64Store2uNative(void* dstp, const p64& src0) { ((uint16_t*)dstp)[0] = (uint16_t)src0; }

static FOG_INLINE void p64Store2aSwap(void* dstp, const p64& src0) { ((uint16_t*)dstp)[0] = Memory::bswap16( (uint16_t)src0 ); }
static FOG_INLINE void p64Store2uSwap(void* dstp, const p64& src0) { ((uint16_t*)dstp)[0] = Memory::bswap16( (uint16_t)src0 ); }

static FOG_INLINE void p64Load4aNative(p64& dst0, const void* srcp) { dst0 = ((const uint32_t*)srcp)[0]; }
static FOG_INLINE void p64Load4uNative(p64& dst0, const void* srcp) { dst0 = ((const uint32_t*)srcp)[0]; }

static FOG_INLINE void p64Load4aSwap(p64& dst0, const void* srcp) { dst0 = Memory::bswap32( ((const uint32_t*)srcp)[0] ); }
static FOG_INLINE void p64Load4uSwap(p64& dst0, const void* srcp) { dst0 = Memory::bswap32( ((const uint32_t*)srcp)[0] ); }

static FOG_INLINE void p64Store4aNative(void* dstp, const p64& src0) { ((uint32_t*)dstp)[0] = (uint32_t)src0; }
static FOG_INLINE void p64Store4uNative(void* dstp, const p64& src0) { ((uint32_t*)dstp)[0] = (uint32_t)src0; }

static FOG_INLINE void p64Store4aSwap(void* dstp, const p64& src0) { ((uint32_t*)dstp)[0] = Memory::bswap32( (uint32_t)src0 ); }
static FOG_INLINE void p64Store4uSwap(void* dstp, const p64& src0) { ((uint32_t*)dstp)[0] = Memory::bswap32( (uint32_t)src0 ); }
...
static FOG_INLINE void p64Load8aNative(p64& dst0, const void* srcp) { dst0 = ((const uint64_t*)srcp)[0]; }
static FOG_INLINE void p64Load8uNative(p64& dst0, const void* srcp) { dst0 = ((const uint64_t*)srcp)[0]; }

static FOG_INLINE void p64Load8aSwap(p64& dst0, const void* srcp) { dst0 = Memory::bswap64( ((const uint64_t*)srcp)[0] ); }
static FOG_INLINE void p64Load8uSwap(p64& dst0, const void* srcp) { dst0 = Memory::bswap64( ((const uint64_t*)srcp)[0] ); }

static FOG_INLINE void p64Store8aNative(void* dstp, const p64& src0) { ((uint64_t*)dstp)[0] = (uint64_t)src0; }
static FOG_INLINE void p64Store8uNative(void* dstp, const p64& src0) { ((uint64_t*)dstp)[0] = (uint64_t)src0; }

static FOG_INLINE void p64Store8aSwap(void* dstp, const p64& src0) { ((uint64_t*)dstp)[0] = Memory::bswap64( (uint64_t)src0 ); }
static FOG_INLINE void p64Store8uSwap(void* dstp, const p64& src0) { ((uint64_t*)dstp)[0] = Memory::bswap64( (uint64_t)src0 ); }
...
static FOG_INLINE void p64Load2aNative(p64& dst0, const void* srcp) { dst0.u32Lo = ((const uint16_t*)srcp)[0]; }
static FOG_INLINE void p64Load2uNative(p64& dst0, const void* srcp) { dst0.u32Lo = ((const uint16_t*)srcp)[0]; }

static FOG_INLINE void p64Load2aSwap(p64& dst0, const void* srcp) { dst0.u32Lo = Memory::bswap16( ((const uint16_t*)srcp)[0] ); }
static FOG_INLINE void p64Load2uSwap(p64& dst0, const void* srcp) { dst0.u32Lo = Memory::bswap16( ((const uint16_t*)srcp)[0] ); }

static FOG_INLINE void p64Store2aNative(void* dstp, const p64& src0) { ((uint16_t*)dstp)[0] = (uint16_t)src0.u32Lo; }
static FOG_INLINE void p64Store2uNative(void* dstp, const p64& src0) { ((uint16_t*)dstp)[0] = (uint16_t)src0.u32Lo; }

static FOG_INLINE void p64Store2aSwap(void* dstp, const p64& src0) { ((uint16_t*)dstp)[0] = Memory::bswap16( (uint16_t)src0.u32Lo ); }
static FOG_INLINE void p64Store2uSwap(void* dstp, const p64& src0) { ((uint16_t*)dstp)[0] = Memory::bswap16( (uint16_t)src0.u32Lo ); }

static FOG_INLINE void p64Load4aNative(p64& dst0, const void* srcp) { dst0.u32Lo = ((const uint32_t*)srcp)[0]; }
static FOG_INLINE void p64Load4uNative(p64& dst0, const void* srcp) { dst0.u32Lo = ((const uint32_t*)srcp)[0]; }

static FOG_INLINE void p64Load4aSwap(p64& dst0, const void* srcp) { dst0.u32Lo = Memory::bswap32( ((const uint32_t*)srcp)[0] ); }
static FOG_INLINE void p64Load4uSwap(p64& dst0, const void* srcp) { dst0.u32Lo = Memory::bswap32( ((const uint32_t*)srcp)[0] ); }

static FOG_INLINE void p64Store4aNative(void* dstp, const p64& src0) { ((uint32_t*)dstp)[0] = (uint32_t)src0.u32Lo; }
static FOG_INLINE void p64Store4uNative(void* dstp, const p64& src0) { ((uint32_t*)dstp)[0] = (uint32_t)src0.u32Lo; }

static FOG_INLINE void p64Store4aSwap(void* dstp, const p64& src0) { ((uint32_t*)dstp)[0] = Memory::bswap32( (uint32_t)src0.u32Lo ); }
static FOG_INLINE void p64Store4uSwap(void* dstp, const p64& src0) { ((uint32_t*)dstp)[0] = Memory::bswap32( (uint32_t)src0.u32Lo ); }
...
static FOG_INLINE void p64Load8aNative(p64& dst0, const void* srcp)
{
  dst0.u32Lo = ((const uint32_t*)srcp)[0];
  dst0.u32Hi = ((const uint32_t*)srcp)[1];
}

static FOG_INLINE void p64Load8uNative(p64& dst0, const void* srcp)
{
  dst0.u32Lo = ((const uint32_t*)srcp)[0];
  dst0.u32Hi = ((const uint32_t*)srcp)[1];
}

static FOG_INLINE void p64Load8aSwap(p64& dst0, const void* srcp)
{
  dst0.u32Hi = Memory::bswap32( ((const uint32_t*)srcp)[0] );
  dst0.u32Lo = Memory::bswap32( ((const uint32_t*)srcp)[1] );
}

static FOG_INLINE void p64Load8uSwap(p64& dst0, const void* srcp)
{
  dst0.u32Hi = Memory::bswap32( ((const uint32_t*)srcp)[0] );
  dst0.u32Lo = Memory::bswap32( ((const uint32_t*)srcp)[1] );
}

static FOG_INLINE void p64Store8aNative(void* dstp, const p64& src0)
{
  ((uint32_t*)dstp)[0] = src0.u32Lo;
  ((uint32_t*)dstp)[1] = src0.u32Hi;
}

static FOG_INLINE void p64Store8uNative(void* dstp, const p64& src0)
{
  ((uint32_t*)dstp)[0] = src0.u32Lo;
  ((uint32_t*)dstp)[1] = src0.u32Hi;
}

static FOG_INLINE void p64Store8aSwap(void* dstp, const p64& src0)
{
  ((uint32_t*)dstp)[0] = Memory::bswap32( src0.u32Hi );
  ((uint32_t*)dstp)[1] = Memory::bswap32( src0.u32Lo );
}

static FOG_INLINE void p64Store8uSwap(void* dstp, const p64& src0)
{
  ((uint32_t*)dstp)[0] = Memory::bswap32( src0.u32Hi );
  ((uint32_t*)dstp)[1] = Memory::bswap32( src0.u32Lo );
}
...
// [Guard]
#endif // _FOG_CORE_FACE_FACE_C_P64_H
