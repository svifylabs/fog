...
#include <Fog/Gui/GuiEngine/X11GuiEngine.h>
    ...
    for (i = 0; i != count; i++)
    {
      ...
      switch (_convertDepth)
      {
        case 8:
          while (y1 < y2)
          {
            ((RasterDither8Fn)_convertFunc)(dstCur, srcCur, w, PointI(x1, y1), palConv);
        ...
        case 16:
          ...
          while (y1 < y2)
          {
            ((RasterDither16Fn)_convertFunc)(dstCur, srcCur, w, PointI(x1, y1));
