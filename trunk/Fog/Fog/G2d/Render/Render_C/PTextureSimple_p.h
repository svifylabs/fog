...
// [Guard]
#ifndef _FOG_G2D_RENDER_RENDER_C_TEXTURESIMPLE_P_H
#define _FOG_G2D_RENDER_RENDER_C_TEXTURESIMPLE_P_H
...
_FetchEnd:
    ...
    RenderPatternFetcher* fetcher, Span* span, uint8_t* buffer)
  {
    ...
    P_FETCH_SPAN8_BEGIN()
      ...
      if (Accessor::FETCH_REFERENCE && fetcher->_mode == RENDER_FETCH_REFERENCE && w <= tw - x)
      {
...
_FetchSkip:
    ...
    RenderPatternFetcher* fetcher, Span* span, uint8_t* buffer)
  {
    ...
    P_FETCH_SPAN8_BEGIN()
      ...
      if (Accessor::FETCH_REFERENCE && fetcher->_mode == RENDER_FETCH_REFERENCE && x <= tw && w < tw - x)
      {
        P_FETCH_SPAN8_SET_CUSTOM(srcLine + (uint)x * Accessor::SRC_BPP);
...
// [Guard]
#endif // _FOG_G2D_RENDER_RENDER_C_TEXTURESIMPLE_P_H
