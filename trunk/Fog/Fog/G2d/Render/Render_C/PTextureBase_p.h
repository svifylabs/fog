    ...
    switch (dstFormat)
    {
      ...
      case IMAGE_FORMAT_RGB24:
        if (srcHasAlpha)
        {
          ...
          fetchFuncs = &_g2d_render.texture.prgb32;
        }
        else
        {
      ...
      case IMAGE_FORMAT_A8:
        ...
        fetchFuncs = &_g2d_render.texture.a8;
...
_Has8BPC:
      ...
      case IMAGE_FORMAT_RGB48:
        if (srcHasAlpha)
        {
          ...
          fetchFuncs = &_g2d_render.texture.prgb64;
        }
        else
        {
          fetchFormat = IMAGE_FORMAT_RGB48;
          fetchFuncs = &_g2d_render.texture.rgb48;
        }
        goto _Has16BPC;

      case IMAGE_FORMAT_A16:
        fetchFormat = IMAGE_FORMAT_A16;
        fetchFuncs = &_g2d_render.texture.a16;
...
// ============================================================================
// [Fog::RenderC - PTextureAccessor - PRGB32]
// ============================================================================
...
struct FOG_NO_EXPORT PTextureAccessor_PRGB32_Base
{
  ...
  FOG_INLINE void fetchNorm(Pixel& dst, const uint8_t* src) { Face::p32Load4aNative(dst, src); }
  FOG_INLINE void fetchSolid(Pixel& dst, const RenderSolid& solid) { dst = solid.prgb32.p32; }
  ...
  FOG_INLINE void store(uint8_t* dst, const Pixel& src) { Face::p32Store4aNative(dst, src); }
...
// ============================================================================
// [Fog::RenderC - PTextureAccessor - PRGB32 <- PRGB32]
// ============================================================================
...
struct FOG_NO_EXPORT PTextureAccessor_PRGB32_From_PRGB32 : public PTextureAccessor_PRGB32_Base
{
  ...
  FOG_INLINE PTextureAccessor_PRGB32_From_PRGB32(const RenderPatternContext* ctx) {}

  FOG_INLINE void fetchRaw(Pixel& dst, const uint8_t* src) { Face::p32Load4aNative(dst, src); }
...
// ============================================================================
// [Fog::RenderC - PTextureAccessor - PRGB32 <- XRGB32]
// ============================================================================
...
struct FOG_NO_EXPORT PTextureAccessor_PRGB32_From_XRGB32 : public PTextureAccessor_PRGB32_Base
{
  ...
  FOG_INLINE PTextureAccessor_PRGB32_From_XRGB32(const RenderPatternContext* ctx) {}
...
// ============================================================================
// [Fog::RenderC - PTextureAccessor - PRGB32 <- RGB24]
// ============================================================================
...
struct FOG_NO_EXPORT PTextureAccessor_PRGB32_From_RGB24 : public PTextureAccessor_PRGB32_Base
{
  ...
  FOG_INLINE PTextureAccessor_PRGB32_From_RGB24(const RenderPatternContext* ctx) {}

  FOG_INLINE void fetchRaw(Pixel& dst, const uint8_t* src) { Face::p32Load3bNative(dst, src); }
...
// ============================================================================
// [Fog::RenderC - PTextureAccessor - PRGB32 <- A8]
// ============================================================================
...
struct FOG_NO_EXPORT PTextureAccessor_PRGB32_From_A8 : public PTextureAccessor_PRGB32_Base
{
  ...
  FOG_INLINE PTextureAccessor_PRGB32_From_A8(const RenderPatternContext* ctx) {}
...
// ============================================================================
// [Fog::RenderC - PTextureAccessor - PRGB32 <- I8]
// ============================================================================
...
struct FOG_NO_EXPORT PTextureAccessor_PRGB32_From_I8 : public PTextureAccessor_PRGB32_Base
{
  ...
  FOG_INLINE PTextureAccessor_PRGB32_From_I8(const RenderPatternContext* ctx) : pal(ctx->_d.texture.base.pal) {}

  FOG_INLINE void fetchRaw(Pixel& dst, const uint8_t* src) { Face::p32Load4aNative(dst, pal + src[0]); }
