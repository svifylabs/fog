...
FOG_NO_EXPORT void Path_init(void)
{
  ...
  _api.pathf.getLastVertex = PathT_getLastVertex<float>;
  _api.pathf.setVertex = PathT_setVertex<float>;
  ...
  _api.pathf.getClosestVertex = PathT_getClosestVertex<float>;
  ...
  _api.pathf.getPathInfo = PathT_getPathInfo<float>;
  _api.pathf.eq = PathT_eq<float>;
  _api.pathf.dCreate = PathT_dCreate<float>;
  _api.pathf.dAdopt = PathT_dAdopt<float>;
  _api.pathf.dFree = PathT_dFree<float>;
  ...
  _api.pathd.getLastVertex = PathT_getLastVertex<double>;
  _api.pathd.setVertex = PathT_setVertex<double>;
  ...
  _api.pathd.getClosestVertex = PathT_getClosestVertex<double>;
  ...
  _api.pathd.getPathInfo = PathT_getPathInfo<double>;
  _api.pathd.eq = PathT_eq<double>;
  _api.pathd.dCreate = PathT_dCreate<double>;
  _api.pathd.dAdopt = PathT_dAdopt<double>;
  _api.pathd.dFree = PathT_dFree<double>;
  ...
  _api.pathf.oEmpty = PathF_oEmpty.initCustom1(df);
  _api.pathd.oEmpty = PathD_oEmpty.initCustom1(dd);
}
