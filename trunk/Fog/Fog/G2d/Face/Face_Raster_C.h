...
static FOG_INLINE void p32UnpackPBW256FromPBB255_2031(p32& dst0_20, p32& dst0_31, const p32& x0)
{
  uint32_t t0 = x0;
...
static FOG_INLINE void p32UnpackPBW256FromPBB255_20Z1(p32& dst0_20, p32& dst0_31, const p32& x0)
{
  uint32_t t0 = x0;
...
static FOG_INLINE void p32XRGB32QuadFromRGB24Quad(
  p32& dst0, p32& dst1, p32& dst2, p32& dst3,
  const p32& x0, const p32& x1, const p32& x2)
{
  uint32_t t0 = x0;
  uint32_t t1 = x1;
  uint32_t t2 = x2;
...
static FOG_INLINE void p32ZRGB32FromRGB16_555(p32& dst0, const p32& x0)
{
...
static FOG_INLINE void p32FRGB32FromRGB16_555(p32& dst0, const p32& x0)
{
  p32ZRGB32FromRGB16_555(dst0, x0);
  p32FillPBB3(dst0, dst0);
}

static FOG_INLINE void p32ZRGB32QuadFromRGB16_555Quad(p32& dst0, p32& dst1, p32& dst2, p32& dst3, const p32& x0, const p32& x1)
{
...
static FOG_INLINE void p32FRGB32QuadFromRGB16_555Quad(p32& dst0, p32& dst1, p32& dst2, p32& dst3, const p32& x0, const p32& x1)
{
...
static FOG_INLINE void p32ZRGB32FromRGB16_565(p32& dst0, const p32& x0)
{
...
static FOG_INLINE void p32FRGB32FromRGB16_565(p32& dst0, const p32& x0)
{
  p32ZRGB32FromRGB16_565(dst0, x0);
  p32FillPBB3(dst0, dst0);
}

static FOG_INLINE void p32ZRGB32QuadFromRGB16_565Quad(p32& dst0, p32& dst1, p32& dst2, p32& dst3, const p32& x0, const p32& x1)
{
  uint32_t t0 = x0;
  uint32_t t1 = x1;
...
static FOG_INLINE void p32FRGB32QuadFromRGB16_565Quad(p32& dst0, p32& dst1, p32& dst2, p32& dst3, const p32& x0, const p32& x1)
{
...
static FOG_INLINE void p32ZRGB32FromRGB48(
  p32& dst0, const p32& x0_r, const p32& x0_g, const p32& x0_b)
{
...
static FOG_INLINE bool p32ARGB32IsAlphaFF(const p32& c0) { return (c0 >= 0xFF000000); }

//! @brief Get whether the ARGB32 pixel @a c0 has alpha set to 0x00 (0 in decimal).
static FOG_INLINE bool p32ARGB32IsAlpha00(const p32& c0) { return (c0 <= 0x00FFFFFF); }
...
static FOG_INLINE void p32ARGB32FromPRGB32_1032(
  p32& dst0_10, p32& dst0_32, const p32& x0_10, const p32& x0_32)
{
  p32 xa = x0_32 >> 16;
  p32 recip = _u8_divide_table_d[xa];

  p32 xr = ((x0_32 & 0xFF) * recip) >> 16;
  p32 xg = ((x0_10 >>  16) * recip) & 0x00FF0000;
  p32 xb = ((x0_10 & 0xFF) * recip) >> 16;
...
static FOG_INLINE void p32ARGB32FromPRGB32_2031(
  p32& dst0_20, p32& dst0_31, const p32& x0_20, const p32& x0_31)
{
  p32 xa = x0_31 >> 16;
  p32 recip = _u8_divide_table_d[xa];

  p32 xr = ((x0_20 >>  16) * recip) & 0x00FF0000;
  p32 xg = ((x0_31 & 0xFF) * recip) >> 16;
  p32 xb = ((x0_20 & 0xFF) * recip) >> 16;
  ...
  p32& dst0, const p32& x0)
{
  ...
  p32 xr = ( (((x0 >> 16) & 0xFF) * recip)      ) & 0x00FF0000;
  p32 xg = ( (((x0 >>  8) & 0xFF) * recip) >>  8) & 0x0000FF00;
  p32 xb = ( (((x0      ) & 0xFF) * recip) >> 16);
...
static FOG_INLINE bool p32PRGB32IsAlphaFF(const p32& c0) { return (c0 >= 0xFF000000); }

//! @brief Get whether the PRGB32 pixel @a c0 has alpha set to 0x00 (0 in decimal).
static FOG_INLINE bool p32PRGB32IsAlpha00(const p32& c0) { return (c0 == 0x00000000); }
...
static FOG_INLINE void p32PRGB32FromARGB32_2031(
  p32& dst0_20, const p32& x0_20,
  p32& dst0_31, const p32& x0_31, const p32& u0)
{
...
static FOG_INLINE void p32PRGB32FromARGB32_1032(
  p32& dst0_10, const p32& x0_10,
  p32& dst0_32, const p32& x0_32, const p32& u0)
{
...
static FOG_INLINE void p32RGB24LerpTriadSolid_PBW256_T(
  p32& dst0, p32& dst1, p32& dst2,
  const p32& x0, const p32& x1, const p32& x2,
  const p32& y0, const p32& msk0_0, const p32& msk0_1)
{
  uint32_t m0;
...
static FOG_INLINE void p32RGB24LerpTriadSolid_PBW256_1032(
  p32& dst0, p32& dst1, p32& dst2,
  const p32& x0, const p32& x1, const p32& x2,
  const p32& y0, const p32& msk0_10, const p32& msk0_32)
{
...
static FOG_INLINE void p32RGB24LerpTriadSolid_PBW256_2031(
  p32& dst0, p32& dst1, p32& dst2,
  const p32& x0, const p32& x1, const p32& x2,
  const p32& y0, const p32& msk0_20, const p32& msk0_31)
{
...
static FOG_INLINE void p32RGB24LerpTriadSolid_PBW256_PMA8(
  p32& dst0, p32& dst1, p32& dst2,
  const p32& x0, const p32& x1, const p32& x2,
  const p32& y0, const p32& msk0_4a, const p32& msk0_4b)
{
#if FOG_BYTE_ORDER == FOG_LITTLE_ENDIAN
...
static FOG_INLINE void p32RGB16_555FromXRGB32(p32& dst0, const p32& x0)
{
...
static FOG_INLINE void p32RGB16_000_555_MulDiv_SBW_5b(p32& dst0, const p32& x0, const p32& u0_5b)
{
...
static FOG_INLINE void p32RGB16_000_555_MulDiv_SBW_8b(p32& dst0, const p32& x0, const p32& u0_8b)
{
  p32 u0_5b;
...
static FOG_INLINE void p32RGB16_555_555_MulDiv_SBW_5b(p32& dst0, const p32& x0, const p32& u0_5b)
{
...
static FOG_INLINE void p32RGB16_555_555_MulDiv_SBW_8b(p32& dst0, const p32& x0, const p32& u0_8b)
{
  p32 u0_5b;
...
static FOG_INLINE void p32RGB16_000_555_MulDiv_PBW_1032(p32& dst0, const p32& x0, const p32& y0_10, const p32& y0_32)
{
...
static FOG_INLINE void p32RGB16_000_555_MulDiv_PBW_2031(p32& dst0, const p32& x0, const p32& y0_20, const p32& y0_31)
{
...
static FOG_INLINE void p32RGB16_565FromXRGB32(p32& dst0, const p32& x0)
{
  //                                 // [XXXXXXXX] [RRRRRRRR] [GGGGGGGG] [BBBBBBBB]
  uint32_t t0;
  uint32_t t1;
...
static FOG_INLINE void p32RGB16_000_565_MulDiv_SBW_6b(p32& dst0, const p32& x0, const p32& u0_6b)
{
...
static FOG_INLINE void p32RGB16_000_565_MulDiv_SBW_8b(p32& dst0, const p32& x0, const p32& u0_8b)
{
  p32 u0_6b;
...
static FOG_INLINE void p32RGB16_000_565_MulDiv_PBW_1032(p32& dst0, const p32& x0, const p32& y0_10, const p32& y0_32)
{
  uint32_t t0 = (x0 & 0x0000001FU) * (y0_10         );
...
static FOG_INLINE void p32RGB16_000_565_MulDiv_PBW_2031(p32& dst0, const p32& x0, const p32& y0_20, const p32& y0_31)
{
  uint32_t t0 = (x0 & 0x0000001FU) * (y0_20         );
...
static FOG_INLINE void p32ZRGB64FromRGB16_555(
  p32& dst0_10, p32& dst0_32, const p32& x0)
{
  //                                      // [XXXXXXXX] [XXXXXXXX] [XRRRRRGG] [GGGBBBBB]
...
static FOG_INLINE bool p32ARGB64IsAlphaFFFF_2031(const p32& c0_20, const p32& c0_31)
{
  return c0_31 >= 0xFFFF0000U;
}

//! @brief Get whether the ARGB64 pixel @a c0 has alpha set to 0x0000 (0 in decimal).
static FOG_INLINE bool p32ARGB64IsAlpha0000_2031(const p32& c0_20, const p32& c0_31)
{
  return c0_31 <= 0x0000FFFFU;
}

//! @brief Get whether the ARGB64 pixel @a c0 has alpha set to 0xFFFF (65535 in decimal).
static FOG_INLINE bool p32ARGB64IsAlphaFFFF_1032(const p32& c0_10, const p32& c0_32)
{
  return c0_32 >= 0xFFFF0000U;
}

//! @brief Get whether the ARGB64 pixel @a c0 has alpha set to 0x0000 (0 in decimal).
static FOG_INLINE bool p32ARGB64IsAlpha0000_1032(const p32& c0_10, const p32& c0_32)
{
  return c0_32 <= 0x0000FFFFU;
}

//! @brief Get whether the ARGB64 pixel @a c0 has alpha set to 0xFFFF (65535 in decimal).
static FOG_INLINE bool p64ARGB64IsAlphaFFFF(const p64& c0)
{
#if defined(FOG_FACE_P64_IS_TYPE)
...
//! @brief Get whether the ARGB64 pixel @a c0 has alpha set to 0x0000 (0 in decimal).
static FOG_INLINE bool p64ARGB64IsAlpha0000(const p64& c0)
{
#if defined(FOG_FACE_P64_IS_TYPE)
...
static FOG_INLINE void p32ARGB64FromPRGB64_2031(p32& dst0_20, p32& dst0_31, const p32& x0_20, const p32& x0_31)
{
  p32 t0 = x0_20;
  p32 t1 = x0_31;
...
static FOG_INLINE void p32ARGB64FromPRGB64_1032(p32& dst0_10, p32& dst0_32, const p32& x0_10, const p32& x0_32)
{
  p32ARGB64FromPRGB64_2031(dst0_10, dst0_32, x0_10, x0_32);
}

static FOG_INLINE void p64ARGB64FromPRGB64(p64& dst0, const p64& x0)
{
#if defined(FOG_FACE_P64_IS_TYPE)
  dst0 = x0;
...
static FOG_INLINE void p64ARGB64FromPRGB64_2031(p64& dst0_20, p64& dst0_31, const p64& x0_20, const p64& x0_31)
{
#if defined(FOG_FACE_P64_IS_TYPE)
  p64 xa = x0_31 >> 32;
  p64 t0 = _FOG_FACE_COMBINE_2(
    ((x0_20 & FOG_UINT64_C(0xFFFFFFFF00000000)) / xa) & FOG_UINT64_C(0xFFFFFFFF00000000),
    ((x0_20 & FOG_UINT64_C(0x00000000FFFFFFFF)) / xa));
  p64 t1 = _FOG_FACE_COMBINE_2(
...
static FOG_INLINE void p64ARGB64FromPRGB64_1032(p64& dst0_10, p64& dst0_32, const p64& x0_10, const p64& x0_32)
{
...
static FOG_INLINE bool p32PRGB64IsAlphaFFFF_2031(const p32& c0_20, const p32& c0_31)
{
  return c0_31 >= 0xFFFF0000U;
}

//! @brief Get whether the PRGB64 pixel @a c0 has alpha set to 0x0000 (0 in decimal).
static FOG_INLINE bool p32PRGB64IsAlpha0000_2031(const p32& c0_20, const p32& c0_31)
{
  return c0_31 == 0x00000000U;
}

//! @brief Get whether the PRGB64 pixel @a c0 has alpha set to 0xFFFF (65535 in decimal).
static FOG_INLINE bool p32PRGB64IsAlphaFFFF_1032(const p32& c0_10, const p32& c0_32)
{
  return c0_32 >= 0xFFFF0000U;
}

//! @brief Get whether the PRGB64 pixel @a c0 has alpha set to 0x0000 (0 in decimal).
static FOG_INLINE bool p32PRGB64IsAlpha0000_1032(const p32& c0_10, const p32& c0_32)
{
  return c0_32 == 0x00000000U;
}

//! @brief Get whether the PRGB64 pixel @a c0 has alpha set to 0xFFFF (65535 in decimal).
static FOG_INLINE bool p64PRGB64IsAlphaFFFF(const p64& c0)
{
#if defined(FOG_FACE_P64_IS_TYPE)
  return c0 >= FOG_UINT64_C(0xFFFF000000000000);
#else
...
//! @brief Get whether the PRGB64 pixel @a c0 has alpha set to 0x0000 (0 in decimal).
static FOG_INLINE bool p64PRGB64IsAlpha0000(const p64& c0)
{
#if defined(FOG_FACE_P64_IS_TYPE)
  return c0 == 0;
#else
...
#if defined(FOG_FACE_P64_IS_TYPE)
  p64 xa = (x0 >> 48);
  p64 t0 = (x0      ) & FOG_UINT64_C(0x0000FFFF0000FFFF);
  p64 t1 = (x0 >> 16) & FOG_UINT64_C(0x0000FFFF0000FFFF);
...
static FOG_INLINE void p64PRGB64FromARGB64_2031(
  p64& dst0_20, p64& dst0_31, const p64& x0_20, const p64& x0_31)
{
#if defined(FOG_FACE_P64_IS_TYPE)
  p64 xa = x0_31 >> 32;

  p64 t0_20 = x0_20;
  p64 t0_31 = x0_31 | FOG_UINT64_C(0x0000FFFF00000000);
