...
FOG_DECLARE_TYPEINFO(Fog::BmpFileHeader, Fog::TYPEINFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::BmpOS2V1Header, Fog::TYPEINFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::BmpWinV3Header, Fog::TYPEINFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::BmpWinV4Header, Fog::TYPEINFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::BmpWinV5Header, Fog::TYPEINFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::BmpDataHeader, Fog::TYPEINFO_PRIMITIVE)
