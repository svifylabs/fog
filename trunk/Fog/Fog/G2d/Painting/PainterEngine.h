...
// [Guard]
#ifndef _FOG_G2D_PAINTING_PAINTERENGINE_H
#define _FOG_G2D_PAINTING_PAINTERENGINE_H
...
struct FOG_NO_EXPORT PainterEngine
{
  // --------------------------------------------------------------------------
  // [Members]
  // --------------------------------------------------------------------------
...
// [Guard]
#endif // _FOG_G2D_PAINTING_PAINTERENGINE_H
