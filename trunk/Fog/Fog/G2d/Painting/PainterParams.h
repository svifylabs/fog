...
union FOG_NO_EXPORT PaintHints
{
  ...
  FOG_INLINE void reset()
  {
    ...
    antialiasingQuality = ANTIALIASING_QUALITY_DEFAULT;
  ...
  struct
  {
    ...
    uint32_t antialiasingQuality : 4;
...
struct FOG_NO_EXPORT PaintParamsF
{
  ...
  FOG_INLINE uint32_t getAntialiasingQuality() const { return _hints.antialiasingQuality; }
  FOG_INLINE void setAntialiasingQuality(uint32_t hint) { _hints.antialiasingQuality = hint; }
...
FOG_DECLARE_TYPEINFO(Fog::PaintParamsF, Fog::TYPEINFO_MOVABLE)
