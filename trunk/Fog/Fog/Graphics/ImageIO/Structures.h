...
FOG_DECLARE_TYPEINFO(Fog::ImageIO::BmpFileHeader, Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::ImageIO::BmpOS2V1Header, Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::ImageIO::BmpWinV3Header, Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::ImageIO::BmpWinV4Header, Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::ImageIO::BmpWinV5Header, Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::ImageIO::BmpDataHeader, Fog::TYPE_INFO_PRIMITIVE)

FOG_DECLARE_TYPEINFO(Fog::ImageIO::PcxHeader, Fog::TYPE_INFO_PRIMITIVE)

FOG_DECLARE_TYPEINFO(Fog::ImageIO::IcoHeader, Fog::TYPE_INFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::ImageIO::IcoEntry, Fog::TYPE_INFO_PRIMITIVE)
