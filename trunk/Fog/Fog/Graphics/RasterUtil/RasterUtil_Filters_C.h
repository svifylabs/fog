...
struct FOG_HIDDEN FilterC
{
  ...
  static void FOG_FASTCALL color_lut_rgb24(
    uint8_t* dst, const uint8_t* src, sysuint_t width, const ColorLutData* lut)
  {
    const uint8_t* rLut = lut->r;
    const uint8_t* gLut = lut->g;
    ...
    uint8_t* dst, const uint8_t* src, sysuint_t width, const float m[5][5])
  {
    ...
    for (sysuint_t i = width; i; i--, dst += 3, src += 3)
    {
      float fr = (float)src[RGB24_RBYTE];
      float fg = (float)src[RGB24_GBYTE];
      float fb = (float)src[RGB24_BBYTE];
      ...
      dst[RGB24_RBYTE] = (uint8_t)tr;
      dst[RGB24_GBYTE] = (uint8_t)tg;
      dst[RGB24_BBYTE] = (uint8_t)tb;
    }
  }
  ...
  static void FOG_FASTCALL box_blur_h_rgb24(
    uint8_t* dst, sysint_t dstStride, const uint8_t* src, sysint_t srcStride,
    sysuint_t width, sysuint_t height, sysint_t offset, const BlurParams* params)
  {
    int radius = Math::min<int>((int)params->hRadius, 254);
    ...
    if (radius == 0 || width < 2)
    {
      functionMap->filter.copy_area[PIXEL_FORMAT_RGB24](dst, dstStride, src, srcStride, width, height, offset, NULL);
      return;
    }
  ...
  static void FOG_FASTCALL box_blur_v_rgb24(
    uint8_t* dst, sysint_t dstStride, const uint8_t* src, sysint_t srcStride,
    sysuint_t width, sysuint_t height, sysint_t offset, const BlurParams* params)
  {
    int radius = Math::min<int>((int)params->vRadius, 254);
  ...
  static void FOG_FASTCALL linear_blur_h_rgb24(
    uint8_t* dst, sysint_t dstStride, const uint8_t* src, sysint_t srcStride,
    sysuint_t width, sysuint_t height, sysint_t offset, const BlurParams* params)
  {
    int radius = Math::min<int>((int)params->hRadius, 254);
  ...
  static void FOG_FASTCALL linear_blur_v_rgb24(
    uint8_t* dst, sysint_t dstStride, const uint8_t* src, sysint_t srcStride,
    sysuint_t width, sysuint_t height, sysint_t offset, const BlurParams* params)
  {
    int radius = Math::min<int>((int)params->vRadius, 254);
  ...
  static void FOG_FASTCALL symmetric_convolve_float_h_rgb24(
    uint8_t* dst, sysint_t dstStride, const uint8_t* src, sysint_t srcStride,
    sysuint_t width, sysuint_t height, sysint_t offset, const SymmetricConvolveParamsF* params)
  {
    const float* kernel = params->hMatrix.getData();
  ...
  static void FOG_FASTCALL symmetric_convolve_float_v_rgb24(
    uint8_t* dst, sysint_t dstStride, const uint8_t* src, sysint_t srcStride,
    sysuint_t width, sysuint_t height, sysint_t offset, const SymmetricConvolveParamsF* params)
  {
    const float* kernel = params->vMatrix.getData();
