...
// ============================================================================
// [Fog::RasterUtil::C - Convert]
// ============================================================================

struct FOG_HIDDEN ConvertC
{
  // --------------------------------------------------------------------------
  // [ConvertC - BSwap]
  // --------------------------------------------------------------------------
  ...
  // --------------------------------------------------------------------------
  // [ConvertC - Axxx32 Dest]
  // --------------------------------------------------------------------------

  static void FOG_FASTCALL axxx32_from_xxxx32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL axxx32_from_a8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL axxx32_bs_from_a8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL argb32_from_prgb32_bs(
    uint8_t* _dst, const uint8_t* _src, sysint_t w, const Closure* closure)
  {
    uint32_t* dst = reinterpret_cast<uint32_t*>(_dst);
    const uint32_t* src = reinterpret_cast<const uint32_t*>(_src);
  ...
  static void FOG_FASTCALL argb32_from_rgb32_bs(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL argb32_bs_from_rgb32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL argb32_bs_from_prgb32(
    uint8_t* _dst, const uint8_t* _src, sysint_t w, const Closure* closure)
  {
    uint32_t* dst = reinterpret_cast<uint32_t*>(_dst);
    const uint32_t* src = reinterpret_cast<const uint32_t*>(_src);
  ...
  static void FOG_FASTCALL argb32_bs_from_i8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    const Argb* srcPal = closure->srcPalette + Palette::INDEX_ARGB32;
  ...
  static void FOG_FASTCALL prgb32_from_argb32_bs(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL prgb32_bs_from_argb32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL prgb32_bs_from_i8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    const Argb* srcPal = closure->srcPalette + Palette::INDEX_PRGB32;
  ...
  // --------------------------------------------------------------------------
  // [ConvertC - Xrgb32 Dest]
  // --------------------------------------------------------------------------

  static void FOG_FASTCALL rgb32_from_argb32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
      ((uint32_t*)dst)[0] = ArgbUtil::premultiply(((const uint32_t*)src)[0]) | 0xFF000000;
  ...
  static void FOG_FASTCALL rgb32_from_argb32_bs(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
      ((uint32_t*)dst)[0] = Memory::bswap32(ArgbUtil::premultiply(((const uint32_t*)src)[0]) | 0xFF000000);
  ...
  static void FOG_FASTCALL rgb32_from_rgb24(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb32_from_bgr24(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL rgb32_from_rgb16_5550(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL rgb32_from_rgb16_5550_bs(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL rgb32_from_rgb16_5650(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL rgb32_from_rgb16_5650_bs(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  static void FOG_FASTCALL rgb32_from_i8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    const Argb* srcPal = closure->srcPalette + Palette::INDEX_PRGB32;
  ...
  static void FOG_FASTCALL rgb32_bs_from_rgb24(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    for (sysint_t i = w; i; i--)
    {
  ...
  // --------------------------------------------------------------------------
  // [ConvertC - Rgb24/Bgr24 Dest]
  // --------------------------------------------------------------------------

  static void FOG_FASTCALL rgb24_from_rgb32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb24_from_rgb32_bs(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb24_from_rgb16_5550(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb24_from_rgb16_5550_bs(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb24_from_rgb16_5650(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb24_from_rgb16_5650_bs(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL bgr24_from_rgb32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL bgr24_from_i8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    const Argb* srcPal = closure->srcPalette + Palette::INDEX_PRGB32;
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5550_from_rgb32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5550_from_rgb24(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5550_from_i8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    const Argb* srcPal = closure->srcPalette + Palette::INDEX_PRGB32;
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5650_from_rgb32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5650_from_rgb24(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5650_from_i8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    const Argb* srcPal = closure->srcPalette + Palette::INDEX_PRGB32;
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5550_bs_from_rgb32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5550_bs_from_rgb24(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5550_bs_from_i8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    const Argb* srcPal = closure->srcPalette + Palette::INDEX_PRGB32;
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5650_bs_from_rgb32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5650_bs_from_rgb24(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb16_5650_bs_from_i8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    const Argb* srcPal = closure->srcPalette + Palette::INDEX_PRGB32;
    sysint_t i = w;
  ...
  static void FOG_FASTCALL greyscale8_from_rgb32(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL greyscale8_from_rgb24(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL greyscale8_from_bgr24(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL greyscale8_from_i8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    const Argb* srcPal = closure->srcPalette + Palette::INDEX_PRGB32;
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb32_from_greyscale8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL rgb24_from_greyscale8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    sysint_t i = w;
  ...
  static void FOG_FASTCALL i8rgb232_from_rgb32_dither(
  ...
  static void FOG_FASTCALL i8rgb222_from_rgb32_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin, const uint8_t* palConv)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL i8rgb111_from_rgb32_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin, const uint8_t* palConv)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL i8rgb232_from_rgb24_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin, const uint8_t* palConv)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL i8rgb222_from_rgb24_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin, const uint8_t* palConv)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL i8rgb111_from_rgb24_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin, const uint8_t* palConv)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL rgb16_5550_from_rgb32_dither(
  ...
  static void FOG_FASTCALL rgb16_5550_from_rgb24_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL rgb16_5650_from_rgb32_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL rgb16_5650_from_rgb24_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL rgb16_5550_bs_from_rgb32_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL rgb16_5550_bs_from_rgb24_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL rgb16_5650_bs_from_rgb32_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin)
  {
    sysint_t i;
  ...
  static void FOG_FASTCALL rgb16_5650_bs_from_rgb24_dither(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Point& origin)
  {
    sysint_t i;
