...
struct FOG_HIDDEN CompositeDifferenceC : public CompositeBaseFuncsC32<CompositeDifferenceC>
{
    ...
    ByteSIMD::b32_1x2& dst1, ByteSIMD::b32_1x2 a1, ByteSIMD::b32_1x2 b1)
  {
    ...
    ByteSIMD::b32_2x2MulDiv255U(at0, a0, at1, a1, ba);
    ByteSIMD::b32_2x2MulDiv255U(bt0, b0, bt1, b1, aa);

    ByteSIMD::b32_2x2MinB32_2x2(at0, at0, bt0, at1, at1, bt1);

    ByteSIMD::b32_2x2AddB32_2x2(dst0, a0, b0, dst1, a1, b1);
    ByteSIMD::b32_2x2SubB32_2x2(dst0, dst0, at0, dst1, dst1, at1);
    ByteSIMD::b32_1x2ZeroB1(at1, at1);
    ByteSIMD::b32_2x2SubusB32_2x2(dst0, dst0, at0, dst1, dst1, at1);
  }
    ...
    ByteSIMD::b32_1x2& dst1, ByteSIMD::b32_1x2 a1, ByteSIMD::b32_1x2 b1)
  {
    ...
    ByteSIMD::b32_2x2MulDiv255U(bt0, b0, bt1, b1, aa);
    ByteSIMD::b32_2x2MinB32_2x2(bt0, bt0, a0, bt1, bt1, a1);

    ByteSIMD::b32_2x2AddB32_2x2(dst0, a0, b0, dst1, a1, b1);
    ByteSIMD::b32_2x2SubB32_2x2(dst0, dst0, bt0, dst1, dst1, bt1);
    ByteSIMD::b32_2x2SubusB32_2x2(dst0, dst0, bt0, dst1, dst1, bt1);
    ...
    ByteSIMD::b32_1x2& dst1, ByteSIMD::b32_1x2 a1, ByteSIMD::b32_1x2 b1)
  {
    ...
    ByteSIMD::b32_2x2MulDiv255U(at0, a0, at1, a1, ba);
    ByteSIMD::b32_2x2MinB32_2x2(at0, at0, b0, at1, at1, b1);
  ...
  {
    ByteSIMD::b32_2x2AddB32_2x2(dst0, a0, b0, dst1, a1, b1);
    ByteSIMD::b32_2x2MinB32_2x2(a0, a0, b0, a1, a1, b1);
