...
struct FOG_HIDDEN CompositeScreenC : public CompositeBaseFuncsC32<CompositeScreenC>
{
    ...
    ByteSIMD::b32_1x2& dst1, ByteSIMD::b32_1x2 a1, ByteSIMD::b32_1x2 b1)
  {
    ...
    ByteSIMD::b32_2x2Negate(b0inv, b0, b1inv, b1);
    ByteSIMD::b32_2x2MulDiv255B32_2x2(dst0, a0, b0inv, dst1, a1, b1inv);
    ByteSIMD::b32_2x2AddB32_2x2(dst0, dst0, b0, dst1, dst1, b1);
  }
