...
struct FOG_NO_EXPORT PathClipperF
{
  ...
  {
    return fog_api.pathclipperf_measurePath(this, &src);
  }
  ...
  {
    return fog_api.pathclipperf_continuePath(this, &dst, &src);
  }

  FOG_INLINE err_t continuePathData(PathF& dst, const PointF* srcPts, const uint8_t* srcCmd, size_t srcLength)
  {
    return fog_api.pathclipperf_continuePathData(this, &dst, srcPts, srcCmd, srcLength);
  }
  ...
  {
    return fog_api.pathclipperf_clipPath(this, &dst, &src, NULL);
  }
...
struct FOG_NO_EXPORT PathClipperD
{
  ...
  {
    return fog_api.pathclipperd_measurePath(this, &src);
  }
  ...
  {
    return fog_api.pathclipperd_continuePath(this, &dst, &src);
  }

  FOG_INLINE err_t continuePathData(PathD& dst, const PointD* srcPts, const uint8_t* srcCmd, size_t srcLength)
  {
    return fog_api.pathclipperd_continuePathData(this, &dst, srcPts, srcCmd, srcLength);
  }
  ...
  {
    return fog_api.pathclipperd_clipPath(this, &dst, &src, NULL);
  }
