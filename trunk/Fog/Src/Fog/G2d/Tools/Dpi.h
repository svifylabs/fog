...
struct FOG_NO_EXPORT Dpi
{
  ...
  FOG_INLINE Dpi()
  {
    fog_api.dpi_reset(this);
  }

  FOG_INLINE Dpi(const Dpi& other)
  {
    fog_api.dpi_copy(this, &other);
  }

  FOG_INLINE explicit Dpi(float dpi)
  {
    fog_api.dpi_setDpi(this, dpi);
  }
  ...
  {
    return fog_api.dpi_setDpi(this, dpi);
  }

  FOG_INLINE err_t setDpi(float dpi, float em, float ex)
  {
    return fog_api.dpi_setDpiEmEx(this, dpi, em, ex);
  }
