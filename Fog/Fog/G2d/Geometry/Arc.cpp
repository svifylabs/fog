...
{
  fog_api.arcf_getBoundingBox = ArcT_getBoundingBox<float>;
  fog_api.arcd_getBoundingBox = ArcT_getBoundingBox<double>;

  fog_api.arcf_toCSpline = ArcT_toCSpline<float>;
  fog_api.arcd_toCSpline = ArcT_toCSpline<double>;
}
