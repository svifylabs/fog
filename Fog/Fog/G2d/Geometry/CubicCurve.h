...
struct FOG_NO_EXPORT CubicCurveF
{
  // --------------------------------------------------------------------------
  // [Construction / Destruction]
  // --------------------------------------------------------------------------

  FOG_INLINE CubicCurveF() {}
  FOG_INLINE CubicCurveF(_Uninitialized) {}

  FOG_INLINE CubicCurveF(const PointF& p0, const PointF& p1, const PointF& p2, const PointF& p3)
  {
    p[0] = p0;
    p[1] = p1;
    p[2] = p2;
  ...
  FOG_INLINE CubicCurveF(float x0, float y0, float x1, float y1, float x2, float y2, float x3, float y3)
  {
    p[0].set(x0, y0);
    p[1].set(x1, y1);
    p[2].set(x2, y2);
  ...
  FOG_INLINE CubicCurveF(const PointF* pts)
  {
    p[0] = pts[0];
    p[1] = pts[1];
    p[2] = pts[2];
  ...
  FOG_INLINE CubicCurveF& operator=(const CubicCurveF& other)
  {
    p[0] = other.p[0];
    p[1] = other.p[1];
    p[2] = other.p[2];
  ...
  FOG_INLINE bool operator==(const CubicCurveF& other) const
  {
  ...
  static FOG_INLINE void leftAt(const CubicCurveF* self, CubicCurveF* left, float t)
  {
  ...
  static FOG_INLINE void rightAt(const CubicCurveF* self, CubicCurveF* rght, float t)
  {
    rightAt(self->p, rght->p, t);
  }

  static FOG_INLINE err_t flatten(const CubicCurveF* self, PathF& dst, uint8_t initialCommand, float flatness)
  {
...
struct FOG_NO_EXPORT CubicCurveD
{
  // --------------------------------------------------------------------------
  // [Construction / Destruction]
  // --------------------------------------------------------------------------

  FOG_INLINE CubicCurveD() {}
  FOG_INLINE CubicCurveD(_Uninitialized) {}

  FOG_INLINE CubicCurveD(const PointD& p0, const PointD& p1, const PointD& p2, const PointD& p3)
  {
    p[0] = p0;
    p[1] = p1;
    p[2] = p2;
  ...
  FOG_INLINE CubicCurveD(double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3)
  {
    p[0].set(x0, y0);
    p[1].set(x1, y1);
    p[2].set(x2, y2);
  ...
  FOG_INLINE CubicCurveD(const PointD* pts)
  {
    p[0] = pts[0];
    p[1] = pts[1];
    p[2] = pts[2];
  ...
  FOG_INLINE CubicCurveD& operator=(const CubicCurveD& other)
  {
    p[0] = other.p[0];
    p[1] = other.p[1];
    p[2] = other.p[2];
  ...
  FOG_INLINE bool operator==(const CubicCurveD& other) const
  {
    return p[0] == other.p[0] &&
           p[1] == other.p[1] &&
           p[2] == other.p[2] &&
  ...
  static FOG_INLINE void leftAt(const CubicCurveD* self, CubicCurveD* left, double t)
  {
    leftAt(self->p, left->p, t);
  }
  ...
  static FOG_INLINE void rightAt(const CubicCurveD* self, CubicCurveD* rght, double t)
  {
    rightAt(self->p, rght->p, t);
  }

  static FOG_INLINE err_t flatten(const CubicCurveD* self, PathD& dst, uint8_t initialCommand, double flatness)
  {
...
FOG_TYPEVARIANT_DECLARE_F_D(CubicCurve)
...
FOG_DECLARE_TYPEINFO(Fog::CubicCurveF, Fog::TYPEINFO_PRIMITIVE)
FOG_DECLARE_TYPEINFO(Fog::CubicCurveD, Fog::TYPEINFO_PRIMITIVE)

// ============================================================================
// [Fog::Fuzzy<>]
// ============================================================================

FOG_DECLARE_FUZZY(Fog::CubicCurveF, Math::feqv((const float *)&a, (const float *)&b, 8))
FOG_DECLARE_FUZZY(Fog::CubicCurveD, Math::feqv((const double*)&a, (const double*)&b, 8))
