...
// [Guard]
#ifndef _FOG_UI_ENGINE_UIENGINEKEYBOARDINFO_H
#define _FOG_UI_ENGINE_UIENGINEKEYBOARDINFO_H
...
// ============================================================================
// [Fog::UIEngineKeyboardInfo]
// ============================================================================

//! @brief Frame-buffer mouse information.
struct FOG_NO_EXPORT UIEngineKeyboardInfo
{
  FOG_INLINE UIEngineKeyboardInfo() :
    _devicesCount(0)
  {
  }

  explicit FOG_INLINE UIEngineKeyboardInfo(_Uninitialized) {}
  ...
  FOG_INLINE bool eq(const UIEngineKeyboardInfo& other) const
  {
  ...
  FOG_INLINE UIEngineKeyboardInfo& operator=(const UIEngineKeyboardInfo& other)
  {
  ...
  FOG_INLINE bool operator==(const UIEngineKeyboardInfo& other) const { return  eq(other); }
  FOG_INLINE bool operator!=(const UIEngineKeyboardInfo& other) const { return !eq(other); }
...
// [Guard]
#endif // _FOG_UI_ENGINE_UIENGINEKEYBOARDINFO_H
