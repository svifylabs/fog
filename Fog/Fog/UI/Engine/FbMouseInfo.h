...
// [Guard]
#ifndef _FOG_UI_ENGINE_FBMOUSEINFO_H
#define _FOG_UI_ENGINE_FBMOUSEINFO_H
...
struct FOG_NO_EXPORT FbMouseInfo
{
  FOG_INLINE FbMouseInfo() :
    _devicesCount(0),
    _wheelLines(0),
  ...
  explicit FOG_INLINE FbMouseInfo(_Uninitialized) {}
  ...
  FOG_INLINE bool eq(const FbMouseInfo& other) const
  {
  ...
  FOG_INLINE FbMouseInfo& operator=(const FbMouseInfo& other)
  {
  ...
  FOG_INLINE bool operator==(const FbMouseInfo& other) const { return  eq(other); }
  FOG_INLINE bool operator!=(const FbMouseInfo& other) const { return !eq(other); }
...
// [Guard]
#endif // _FOG_UI_ENGINE_FBMOUSEINFO_H
