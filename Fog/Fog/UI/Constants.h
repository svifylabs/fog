...
{
  // Errors Range.
  ERR_UI_START = 0x00011200,
  ERR_UI_LAST     = 0x000112FF,

  // UI Errors.
  ERR_UI_NOT_INITIALIZED = ERR_UI_START,
  ERR_UI_INTERNAL_ERROR,

  ERR_UI_CANT_CREATE_UISYSTEM,
  ERR_UI_CANT_CREATE_UIWINDOW,
  ...
  ERR_UI_CANT_TRANSLETE_COORDINATES,

  ERR_UI_WINDOW_ALREADY_EXISTS
};
