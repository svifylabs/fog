...
FOG_IMPLEMENT_OBJECT(Fog::WinUISystem)
FOG_IMPLEMENT_OBJECT(Fog::WinUIWindow)
...
#define UI_SYSTEM() \
  reinterpret_cast<WinUISystem*>(Application::getInstance()->getUiSystem())
...
// ============================================================================
// [Fog::WinUISystem - Construction / Destruction]
// ============================================================================

WinUISystem::WinUISystem()
{
...
// ============================================================================
// [Fog::WinUISystem - Display]
// ============================================================================

void WinUISystem::updateDisplayInfo()
{
  int dibSize;
...
// ============================================================================
// [Fog::WinUISystem - Update]
// ============================================================================

void WinUISystem::doBlitWindow(UIWindow* window, const Box* rects, sysuint_t count)
{
...
// ============================================================================
// [Fog::WinUISystem - UIWindow]
// ============================================================================

UIWindow* WinUISystem::createUIWindow(Widget* widget)
{
  return new(std::nothrow) WinUIWindow(widget);
}

void WinUISystem::destroyUIWindow(UIWindow* native)
{
  delete native;
}

// ============================================================================
// [Fog::WinUISystem - Windows Specific]
// ============================================================================

uint32_t WinUISystem::winKeyToModifier(WPARAM* wParam, LPARAM lParam)
{
  uint32_t modifier = 0;
...
uint32_t WinUISystem::winKeyToUnicode(UINT vKey, UINT scanCode)
{
  switch (vKey)
  {
    case VK_LEFT:
...
uint32_t WinUISystem::winKeyToFogKey(WPARAM vk, UINT scancode)
{
  uint32_t key;
...
// ============================================================================
// [Fog::WinUISystem - Debug]
// ============================================================================

const char* WinUISystem::msgToStr(uint message)
{
  struct MsgTable
  {
    uint message;
...
fail:
  return ERR_UI_CANT_CREATE_UIWINDOW;
}
...
err_t WinUIWindow::worldToClient(Point* coords)
{
  ...
  return ScreenToClient((HWND)_handle, (POINT *)coords)
    ? (err_t)ERR_OK
    : (err_t)ERR_UI_CANT_TRANSLETE_COORDINATES;
}
...
{
  WinUISystem* uiSystem = UI_SYSTEM();
