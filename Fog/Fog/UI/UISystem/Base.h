...
// [Guard]
#ifndef _FOG_UI_UISYSTEM_BASE_H
#define _FOG_UI_UISYSTEM_BASE_H
...
//! methods.
struct FOG_API BaseUISystem : public UISystem
{
  FOG_DECLARE_OBJECT(BaseUISystem, UISystem)
...
struct FOG_API BaseUIWindow : public UIWindow
{
  FOG_DECLARE_OBJECT(BaseUIWindow, UIWindow)

  // --------------------------------------------------------------------------
  // [Construction / Destruction]
  // --------------------------------------------------------------------------

  BaseUIWindow(Widget* widget);
  virtual ~BaseUIWindow();
