...
struct BlurEngine8
{
  ...
  static FOG_INLINE void combine1(uint8_t* dest, const uint8_t* c0)
  {
    dest[0] = c0[0];
  }

  static FOG_INLINE void combine2(uint8_t* dest, const uint8_t* c0, const uint8_t* c1)
  {
    dest[0] = (uint8_t)(((uint32_t)c0[0] + (uint32_t)c1[0]) >> 1);
  }

  static FOG_INLINE void combine3(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2)
  {
    dest[0] = (uint8_t)(((((uint32_t)c0[0] + (uint32_t)c1[0]) >> 1) + (uint32_t)c2[0]) >> 1);
  }

  static FOG_INLINE void combine4(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2, const uint8_t* c3)
  {
    dest[0] = (uint8_t)(((uint32_t)c0[0] + (uint32_t)c1[0] + (uint32_t)c2[0] + (uint32_t)c3[0]) >> 2);
  }

  static FOG_INLINE void combine5(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2, const uint8_t* c3, const uint8_t* c4)
  {
    dest[0] = (uint8_t)(((((uint32_t)c0[0] + (uint32_t)c1[0] + (uint32_t)c2[0] + (uint32_t)c3[0]) >> 2) + (uint32_t)c4[0]) >> 1);
  }

  static FOG_INLINE void combine6(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2, const uint8_t* c3, const uint8_t* c4, const uint8_t* c5)
  {
    dest[0] = (uint8_t)(((uint32_t)c0[0] + (uint32_t)c1[0] + (uint32_t)c2[0] + (uint32_t)c3[0] + (uint32_t)c4[0] + (uint32_t)c5[0]) / 6);
  }
};
...
struct BlurEngine24
{
  ...
  {
    dest[0] = (uint8_t)(((uint32_t)c0[0] + (uint32_t)c1[0]) >> 1);
    dest[1] = (uint8_t)(((uint32_t)c0[1] + (uint32_t)c1[1]) >> 1);
    dest[2] = (uint8_t)(((uint32_t)c0[2] + (uint32_t)c1[2]) >> 1);
  }

  static FOG_INLINE void combine3(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2)
  {
    dest[0] = (uint8_t)(((((uint32_t)c0[0] + (uint32_t)c1[0]) >> 1) + (uint32_t)c2[0]) >> 1);
    dest[1] = (uint8_t)(((((uint32_t)c0[1] + (uint32_t)c1[1]) >> 1) + (uint32_t)c2[1]) >> 1);
    dest[2] = (uint8_t)(((((uint32_t)c0[2] + (uint32_t)c1[2]) >> 1) + (uint32_t)c2[2]) >> 1);
  }

  static FOG_INLINE void combine4(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2, const uint8_t* c3)
  {
    dest[0] = (uint8_t)(((uint32_t)c0[0] + (uint32_t)c1[0] + (uint32_t)c2[0] + (uint32_t)c3[0]) >> 2);
    dest[1] = (uint8_t)(((uint32_t)c0[1] + (uint32_t)c1[1] + (uint32_t)c2[1] + (uint32_t)c3[1]) >> 2);
    dest[2] = (uint8_t)(((uint32_t)c0[2] + (uint32_t)c1[2] + (uint32_t)c2[2] + (uint32_t)c3[2]) >> 2);
  }

  static FOG_INLINE void combine5(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2, const uint8_t* c3, const uint8_t* c4)
  {
    dest[0] = (uint8_t)(((((uint32_t)c0[0] + (uint32_t)c1[0] + (uint32_t)c2[0] + (uint32_t)c3[0]) >> 2) + (uint32_t)c4[0]) >> 1);
    dest[1] = (uint8_t)(((((uint32_t)c0[1] + (uint32_t)c1[1] + (uint32_t)c2[1] + (uint32_t)c3[1]) >> 2) + (uint32_t)c4[1]) >> 1);
    dest[2] = (uint8_t)(((((uint32_t)c0[2] + (uint32_t)c1[2] + (uint32_t)c2[2] + (uint32_t)c3[2]) >> 2) + (uint32_t)c4[2]) >> 1);
  }

  static FOG_INLINE void combine6(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2, const uint8_t* c3, const uint8_t* c4,  const uint8_t* c5)
  {
    dest[0] = (uint8_t)(((uint32_t)c0[0] + (uint32_t)c1[0] + (uint32_t)c2[0] + (uint32_t)c3[0] + (uint32_t)c4[0] + (uint32_t)c5[0]) / 6);
    dest[1] = (uint8_t)(((uint32_t)c0[1] + (uint32_t)c1[1] + (uint32_t)c2[1] + (uint32_t)c3[1] + (uint32_t)c4[1] + (uint32_t)c5[0]) / 6);
    dest[2] = (uint8_t)(((uint32_t)c0[2] + (uint32_t)c1[2] + (uint32_t)c2[2] + (uint32_t)c3[2] + (uint32_t)c4[2] + (uint32_t)c5[0]) / 6);
  }
};
...
struct BlurEngine32
{
  ...
  static FOG_INLINE uint32_t _half(uint32_t c0, uint32_t c1)
  {
    return (((c0 ^ c1) & 0xFEFEFEFEU) >> 1) + (c0 & c1);
  }

  static FOG_INLINE void combine1(uint8_t* dest, const uint8_t* c0)
  {
    ((uint32_t *)dest)[0] = ((const uint32_t *)c0)[0];
  }

  static FOG_INLINE void combine2(uint8_t* dest, const uint8_t* c0, const uint8_t* c1)
  {
    ((uint32_t *)dest)[0] = _half(((const uint32_t *)c0)[0], ((const uint32_t *)c1)[0]);
  }

  static FOG_INLINE void combine3(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2)
  {
    ((uint32_t *)dest)[0] = _half(_half(((const uint32_t *)c0)[0], ((const uint32_t *)c1)[0]), ((const uint32_t *)c2)[0]);
  }

  static FOG_INLINE void combine4(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2, const uint8_t* c3)
  {
    ((uint32_t *)dest)[0] = _half(
      _half(((const uint32_t *)c0)[0], ((const uint32_t *)c1)[0]),
      _half(((const uint32_t *)c2)[0], ((const uint32_t *)c3)[0]));
  }
  ...
  static FOG_INLINE void combine6(uint8_t* dest, const uint8_t* c0, const uint8_t* c1, const uint8_t* c2, const uint8_t* c3, const uint8_t* c4, const uint8_t* c5)
  {
    ((uint32_t *)dest)[0] = _half(
      _half(
        _half(((const uint32_t *)c0)[0], ((const uint32_t *)c1)[0]),
        _half(((const uint32_t *)c2)[0], ((const uint32_t *)c3)[0])),
      _half(((const uint32_t *)c4)[0], ((const uint32_t *)c5)[0]));
  }
};

typedef void (FOG_FASTCALL* Fog_Image_BlurScanlineFunc)(
  uint8_t* dest, 
  const uint8_t* src0, 
  const uint8_t* src1,
  const uint8_t* src2, 
...
static void FOG_FASTCALL Fog_Image_blurScanline0x4(
  uint8_t* dest, 
  const uint8_t* src0, 
  const uint8_t* src1,
  const uint8_t* src2, 
  sysuint_t w)
{
  // minimum width for this function is 2

  sysuint_t x;

  if (src0 == NULL || src2 == NULL)
  {
    if (src0 == NULL && src2 == NULL)
    {
      // non-common 1 height blur
      Engine::combine1(dest, src0 + Engine::BytesPerPixel);

      dest += Engine::BytesPerPixel;
      src0 += Engine::BytesPerPixel;

      x = w - 2;
      while (x)
      {
        Engine::combine2(dest, src0 - Engine::BytesPerPixel, src0 + Engine::BytesPerPixel);
        dest += Engine::BytesPerPixel;
        src0 += Engine::BytesPerPixel;
        x--;
      }
    ...
    {
      // non-common blur of 2 scanlines into 1. Loop creates destination
      // color from three colors that's not as fast as 4-color halfing.
      if (src0 == NULL) src0 = src2;

      Engine::combine2(dest, src0, src1 + Engine::BytesPerPixel);
      dest += Engine::BytesPerPixel;
      src0 += Engine::BytesPerPixel;
      src1 += Engine::BytesPerPixel;

      x = w - 2;
      while (x)
      {
        Engine::combine3(dest, src0, src1 - Engine::BytesPerPixel, src1 + Engine::BytesPerPixel);
        dest += Engine::BytesPerPixel;
        src0 += Engine::BytesPerPixel;
        src1 += Engine::BytesPerPixel;
        x--;
  ...
  // common blur effect using three scanlines and generating one. This is
  // the best case, because we are halfing 4 colors that's very good for
  // the cpu.
  else
  {
    Engine::combine3(dest, src0, src1 + Engine::BytesPerPixel, src2);
    dest += Engine::BytesPerPixel;
    src0 += Engine::BytesPerPixel;
    src1 += Engine::BytesPerPixel;
    src2 += Engine::BytesPerPixel;

    x = w - 2;
    while (x)
    {
      Engine::combine4(dest, src0, src1 - Engine::BytesPerPixel, src1 + Engine::BytesPerPixel, src2);
      dest += Engine::BytesPerPixel;
      src0 += Engine::BytesPerPixel;
      src1 += Engine::BytesPerPixel;
      src2 += Engine::BytesPerPixel;
...
template<class Engine>
static void FOG_FASTCALL Fog_Image_blurScanline1x4(
  uint8_t* dest, 
  const uint8_t* src0, 
  const uint8_t* src1,
  const uint8_t* src2, 
  sysuint_t w)
{
  ...
  if (src0 == NULL || src2 == NULL)
  {
    ...
    {
      // non-common 1 height blur
      Engine::combine2(dest, src1, src1 + Engine::BytesPerPixel);
      ...
      while (x)
      {
        Engine::combine3(dest, src1, src1 - Engine::BytesPerPixel, src1 + Engine::BytesPerPixel);
        dest += Engine::BytesPerPixel;
        src0 += Engine::BytesPerPixel;
        x--;
      }

      Engine::combine2(dest, src1, src0 - Engine::BytesPerPixel);
    }
    else
    {
      // non-common blur of 2 scanlines into 1. Loop creates destination
      ...
      Engine::combine3(dest, src0, src1, src1 + Engine::BytesPerPixel);
      dest += Engine::BytesPerPixel;
      src0 += Engine::BytesPerPixel;
      src1 += Engine::BytesPerPixel;
      ...
      while (x)
      {
        Engine::combine4(dest, src0, src1, src1 - Engine::BytesPerPixel, src1 + Engine::BytesPerPixel);
        dest += Engine::BytesPerPixel;
        src0 += Engine::BytesPerPixel;
        src1 += Engine::BytesPerPixel;
        x--;
  ...
  {
    Engine::combine4(dest, src0, src1, src1 + Engine::BytesPerPixel, src2);
    dest += Engine::BytesPerPixel;
    src0 += Engine::BytesPerPixel;
    src1 += Engine::BytesPerPixel;
    src2 += Engine::BytesPerPixel;
    ...
    while (x)
    {
      Engine::combine5(dest, src0, src1, src1 - Engine::BytesPerPixel, src1 + Engine::BytesPerPixel, src2);
      dest += Engine::BytesPerPixel;
      src0 += Engine::BytesPerPixel;
      src1 += Engine::BytesPerPixel;
      src2 += Engine::BytesPerPixel;
...
template<class Engine>
static void FOG_FASTCALL Fog_Image_blurScanline2x4(
  uint8_t* dest, 
  const uint8_t* src0, 
  const uint8_t* src1,
  const uint8_t* src2, 
  sysuint_t w)
{
  ...
  if (src0 == NULL || src2 == NULL)
  {
    ...
    {
      // non-common 1 height blur
      Engine::combine3(dest, src1, src1, src1 + Engine::BytesPerPixel);
      ...
      while (x)
      {
        Engine::combine4(dest, src1, src1, src1 - Engine::BytesPerPixel, src1 + Engine::BytesPerPixel);
        dest += Engine::BytesPerPixel;
        src0 += Engine::BytesPerPixel;
        x--;
      }

      Engine::combine3(dest, src1, src1, src0 - Engine::BytesPerPixel);
    }
    else
    {
      // non-common blur of 2 scanlines into 1. Loop creates destination
      ...
      Engine::combine4(dest, src0, src1, src1, src1 + Engine::BytesPerPixel);
      dest += Engine::BytesPerPixel;
      src0 += Engine::BytesPerPixel;
      src1 += Engine::BytesPerPixel;
      ...
      while (x)
      {
        Engine::combine5(dest, src0, src1, src1, src1 - Engine::BytesPerPixel, src1 + Engine::BytesPerPixel);
        dest += Engine::BytesPerPixel;
        src0 += Engine::BytesPerPixel;
        src1 += Engine::BytesPerPixel;
        x--;
  ...
  {
    Engine::combine5(dest, src0, src1, src1, src1 + Engine::BytesPerPixel, src2);
    dest += Engine::BytesPerPixel;
    src0 += Engine::BytesPerPixel;
    src1 += Engine::BytesPerPixel;
    src2 += Engine::BytesPerPixel;
    ...
    while (x)
    {
      Engine::combine6(dest, src0, src1, src1, src1 - Engine::BytesPerPixel, src1 + Engine::BytesPerPixel, src2);
      dest += Engine::BytesPerPixel;
      src0 += Engine::BytesPerPixel;
      src1 += Engine::BytesPerPixel;
      src2 += Engine::BytesPerPixel;
...
#define BlurModeCount 3

static const Fog_Image_BlurScanlineFunc blurScanlineFuncs[] = 
{
  Fog_Image_blurScanline0x4<BlurEngine32>,
  Fog_Image_blurScanline1x4<BlurEngine32>,
  Fog_Image_blurScanline2x4<BlurEngine32>,
  Fog_Image_blurScanline0x4<BlurEngine24>,
  Fog_Image_blurScanline1x4<BlurEngine24>,
  Fog_Image_blurScanline2x4<BlurEngine24>,
  Fog_Image_blurScanline0x4<BlurEngine8>,
  Fog_Image_blurScanline1x4<BlurEngine8>,
  Fog_Image_blurScanline2x4<BlurEngine8>
};

bool Image::blur(Image& dest, const Image& src, uint32_t blurMode)
{
  ImageFormat format = src.format();
  ...
  sysuint_t w = (sysuint_t)src_d->width;
  sysuint_t h = (sysuint_t)src_d->height;
  sysuint_t hm1 = h-1;

  sysuint_t y;

  Fog_Image_BlurScanlineFunc blurScanline;

  switch (format.id())
  {
    case ImageFormat::ARGB32:
    case ImageFormat::XRGB32:
      blurScanline = blurScanlineFuncs[BlurModeCount * 0 + blurMode];
      break;
    case ImageFormat::RGB24:
      blurScanline = blurScanlineFuncs[BlurModeCount * 1 + blurMode];
      break;
    case ImageFormat::A8:
      blurScanline = blurScanlineFuncs[BlurModeCount * 2 + blurMode];
      break;
    default:
      return false;
  }

  for (y = 0; y != h; y++, destPixels += destStride, srcPixels += srcStride)
  {
    blurScanline(
      destPixels,
      (y == 0) ? NULL : srcPixels - srcStride,
      srcPixels,
      (y == hm1) ? NULL : srcPixels + srcStride, w);
  }
  return true;
}
