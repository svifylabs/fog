...
// ============================================================================
// [Fog::RasterUtil::C - Gradient]
// ============================================================================

struct FOG_HIDDEN GradientC
{
  // --------------------------------------------------------------------------
  // [Gradient]
  // --------------------------------------------------------------------------
  ...
  static void FOG_FASTCALL gradient_prgb32(uint8_t* dst, uint32_t c0, uint32_t c1, sysint_t w, sysint_t x1, sysint_t x2)
  {
    ...
    {
      gradient_rgb32(dst, c0, c1, w, x1, x2);
      return;
    }
  ...
  static void FOG_FASTCALL gradient_rgb32(uint8_t* dst, uint32_t c0, uint32_t c1, sysint_t w, sysint_t x1, sysint_t x2)
  {
    // This function is using fixed point 9.23 calculation to interpolate between
    // packed 8 bit integers. 9 bits are needed to extend 8 bit value with sign.
    uint8_t* dstCur = dst;
  ...
  static void FOG_FASTCALL gradient_rgb24(uint8_t* dst, uint32_t c0, uint32_t c1, sysint_t w, sysint_t x1, sysint_t x2)
  {
    // This function is using fixed point 9.23 calculation to interpolate between
    // packed 8 bit integers. 9 bits are needed to extend 8 bit value with sign.
    uint8_t* dstCur = dst;
  ...
  static void FOG_FASTCALL gradient_a8(uint8_t* dst, uint32_t c0, uint32_t c1, sysint_t w, sysint_t x1, sysint_t x2)
  {
    // This function is using fixed point 9.23 calculation to interpolate between
    // packed 8 bit integers. 9 bits are needed to extend 8 bit value with sign.
    uint8_t* dstCur = dst;
