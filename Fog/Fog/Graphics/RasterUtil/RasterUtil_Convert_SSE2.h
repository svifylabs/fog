...
// ============================================================================
// [Fog::RasterUtil::SSE2 - Convert]
// ============================================================================

struct FOG_HIDDEN ConvertSSE2
{
  // --------------------------------------------------------------------------
  // [ConvertSSE2 - MemCpy]
  // --------------------------------------------------------------------------
  ...
  static void FOG_FASTCALL prgb32_from_a8(
    uint8_t* dst, const uint8_t* src, sysint_t w, const Closure* closure)
  {
    BLIT_SSE2_32x4_INIT(dst, w);
