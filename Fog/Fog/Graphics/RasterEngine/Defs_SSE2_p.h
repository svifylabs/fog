...
// RGB16 masks.
FOG_SSE_DECLARE_CONST_PI16_VAR(0000F8000000F800_0000F8000000F800, 0x0000, 0xF800, 0x0000, 0xF800, 0x0000, 0xF800, 0x0000, 0xF800);
FOG_SSE_DECLARE_CONST_PI16_VAR(0000E0000000E000_0000E0000000E000, 0x0000, 0xE000, 0x0000, 0xE000, 0x0000, 0xE000, 0x0000, 0xE000);
FOG_SSE_DECLARE_CONST_PI16_VAR(00007C0000007C00_00007C0000007C00, 0x0000, 0x7C00, 0x0000, 0x7C00, 0x0000, 0x7C00, 0x0000, 0x7C00);
FOG_SSE_DECLARE_CONST_PI16_VAR(0000700000007000_0000700000007000, 0x0000, 0x7000, 0x0000, 0x7000, 0x0000, 0x7000, 0x0000, 0x7000);
FOG_SSE_DECLARE_CONST_PI16_VAR(0000380000003800_0000380000003800, 0x0000, 0x3800, 0x0000, 0x3800, 0x0000, 0x3800, 0x0000, 0x3800);
FOG_SSE_DECLARE_CONST_PI16_VAR(00001F0000001F00_00001F0000001F00, 0x0000, 0x1F00, 0x0000, 0x1F00, 0x0000, 0x1F00, 0x0000, 0x1F00);
FOG_SSE_DECLARE_CONST_PI16_VAR(00001C0000001C00_00001C0000001C00, 0x0000, 0x1C00, 0x0000, 0x1C00, 0x0000, 0x1C00, 0x0000, 0x1C00);
FOG_SSE_DECLARE_CONST_PI16_VAR(000007E0000007E0_000007E0000007E0, 0x0000, 0x07E0, 0x0000, 0x07E0, 0x0000, 0x07E0, 0x0000, 0x07E0);
FOG_SSE_DECLARE_CONST_PI16_VAR(000003E0000003E0_000003E0000003E0, 0x0000, 0x03E0, 0x0000, 0x03E0, 0x0000, 0x03E0, 0x0000, 0x03E0);
FOG_SSE_DECLARE_CONST_PI16_VAR(000000F8000000F8_000000F8000000F8, 0x0000, 0x00F8, 0x0000, 0x00F8, 0x0000, 0x00F8, 0x0000, 0x00F8);
FOG_SSE_DECLARE_CONST_PI16_VAR(0000007C0000007C_0000007C0000007C, 0x0000, 0x007C, 0x0000, 0x007C, 0x0000, 0x007C, 0x0000, 0x007C);
FOG_SSE_DECLARE_CONST_PI16_VAR(0000001F0000001F_0000001F0000001F, 0x0000, 0x001F, 0x0000, 0x001F, 0x0000, 0x001F, 0x0000, 0x001F);
FOG_SSE_DECLARE_CONST_PI16_VAR(0000000700000007_0000000700000007, 0x0000, 0x0007, 0x0000, 0x0007, 0x0000, 0x0007, 0x0000, 0x0007);
FOG_SSE_DECLARE_CONST_PI16_VAR(0000000300000003_0000000300000003, 0x0000, 0x0003, 0x0000, 0x0003, 0x0000, 0x0003, 0x0000, 0x0003);

// D masks
FOG_SSE_DECLARE_CONST_PI32_VAR(0001000000000000_0000000000000000, 0x00010000, 0x00000000, 0x00000000, 0x00000000);
FOG_SSE_DECLARE_CONST_PI32_VAR(0001000000010000_0000000000000000, 0x00010000, 0x00010000, 0x00000000, 0x00000000);

// Float masks
FOG_SSE_DECLARE_CONST_PI32_VAR(7FFFFFFF7FFFFFFF_7FFFFFFF7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF, 0x7FFFFFFF);
// 1.0, 0x0, 0x0, 0x0, for float demultiply.
FOG_SSE_DECLARE_CONST_PI32_VAR(3F80000000000000_0000000000000000, 0x3F800000, 0x00000000, 0x00000000, 0x00000000);

// Double masks
FOG_SSE_DECLARE_CONST_PI32_VAR(7FFFFFFFFFFFFFFF_7FFFFFFFFFFFFFFF, 0x7FFFFFFF, 0xFFFFFFFF, 0x7FFFFFFF, 0xFFFFFFFF);
FOG_SSE_DECLARE_CONST_PD_VAR(0_5_0_5, 0.5, 0.5);
FOG_SSE_DECLARE_CONST_PD_VAR(1_0_1_0, 1.0, 1.0);
FOG_SSE_DECLARE_CONST_PD_VAR(65536_0_65536_0, 65536.0, 65536.0);
FOG_SSE_DECLARE_CONST_PD_VAR(32768_0_32768_0, 32768.0, 32768.0);
...
static FOG_INLINE void sse2_negate_1x1B(
  __m128i& dst0, const __m128i& src0)
{
  dst0 = _mm_xor_si128(src0, FOG_SSE_GET_CONST_PI(0000000000000000_00000000FFFFFFFF));
}

static FOG_INLINE void sse2_negate_1x4B(
  __m128i& dst0, const __m128i& src0)
{
  dst0 = _mm_xor_si128(src0, FOG_SSE_GET_CONST_PI(FFFFFFFFFFFFFFFF_FFFFFFFFFFFFFFFF));
}

static FOG_INLINE void sse2_negate_1x1W(
  __m128i& dst0, const __m128i& src0)
{
  dst0 = _mm_xor_si128(src0, FOG_SSE_GET_CONST_PI(00FF00FF00FF00FF_00FF00FF00FF00FF));
}
...
static FOG_INLINE void sse2_negate_1x2W_lo(
  __m128i& dst0, const __m128i& src0)
{
  dst0 = _mm_xor_si128(src0, FOG_SSE_GET_CONST_PI(0000000000000000_00FF00FF00FF00FF));
}

static FOG_INLINE void sse2_negate_1x2W_hi(
  __m128i& dst0, const __m128i& src0)
{
  dst0 = _mm_xor_si128(src0, FOG_SSE_GET_CONST_PI(00FF00FF00FF00FF_0000000000000000));
}
...
{
  dst0 = _mm_xor_si128(src0, FOG_SSE_GET_CONST_PI(00FF00FF00FF00FF_00FF00FF00FF00FF));
  dst1 = _mm_xor_si128(src1, FOG_SSE_GET_CONST_PI(00FF00FF00FF00FF_00FF00FF00FF00FF));
}

static FOG_INLINE void sse2_negate_alpha_1x1B(__m128i& dst0xmm, const __m128i& src0xmm)
{
  dst0xmm = _mm_xor_si128(src0xmm, FOG_SSE_GET_CONST_PI(0000000000000000_00000000FF000000));
}

static FOG_INLINE void sse2_negate_alpha_1x4B(__m128i& dst0xmm, const __m128i& src0xmm)
{
  dst0xmm = _mm_xor_si128(src0xmm, FOG_SSE_GET_CONST_PI(FF000000FF000000_FF000000FF000000));
}
  ...
  __m128i& dst1, const __m128i& data1, const __m128i& alpha1)
{
  ...
  dst0 = _mm_adds_epu16(dst0, FOG_SSE_GET_CONST_PI(0080008000800080_0080008000800080));
  dst1 = _mm_adds_epu16(dst1, FOG_SSE_GET_CONST_PI(0080008000800080_0080008000800080));
  dst0 = _mm_mulhi_epu16(dst0, FOG_SSE_GET_CONST_PI(0101010101010101_0101010101010101));
  dst1 = _mm_mulhi_epu16(dst1, FOG_SSE_GET_CONST_PI(0101010101010101_0101010101010101));
}
...
static FOG_INLINE void sse2_fill_alpha_1x1B(
  __m128i& dst0)
{
  dst0 = _mm_or_si128(dst0, FOG_SSE_GET_CONST_PI(FF000000FF000000_FF000000FF000000));
}
...
static FOG_INLINE void sse2_fill_alpha_1x1W(
  __m128i& dst0)
{
  dst0 = _mm_or_si128(dst0, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
}
...
static FOG_INLINE void sse2_fill_alpha_1x2W_lo(
  __m128i& dst0)
{
  dst0 = _mm_or_si128(dst0, FOG_SSE_GET_CONST_PI(0000000000000000_00FF000000000000));
}

static FOG_INLINE void sse2_fill_alpha_1x2W_hi(
  __m128i& dst0)
{
  dst0 = _mm_or_si128(dst0, FOG_SSE_GET_CONST_PI(00FF000000000000_0000000000000000));
}
...
{
  dst0 = _mm_or_si128(dst0, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
  dst1 = _mm_or_si128(dst1, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
}
...
static FOG_INLINE void sse2_zero_alpha_1x1B(
  __m128i& dst0)
{
  dst0 = _mm_and_si128(dst0, FOG_SSE_GET_CONST_PI(00FFFFFF00FFFFFF_00FFFFFF00FFFFFF));
}
...
static FOG_INLINE void sse2_zero_alpha_1x1W(
  __m128i& dst0)
{
  dst0 = _mm_and_si128(dst0, FOG_SSE_GET_CONST_PI(000000FF00FF00FF_000000FF00FF00FF));
}
...
static FOG_INLINE void sse2_zero_alpha_1x2W_lo(
  __m128i& dst0)
{
  dst0 = _mm_and_si128(dst0, FOG_SSE_GET_CONST_PI(00FF00FF00FF00FF_000000FF00FF00FF));
}

static FOG_INLINE void sse2_zero_alpha_1x2W_hi(
  __m128i& dst0)
{
  dst0 = _mm_and_si128(dst0, FOG_SSE_GET_CONST_PI(000000FF00FF00FF_00FF00FF00FF00FF));
}
...
{
  dst0 = _mm_and_si128(dst0, FOG_SSE_GET_CONST_PI(000000FF00FF00FF_000000FF00FF00FF));
  dst1 = _mm_and_si128(dst1, FOG_SSE_GET_CONST_PI(000000FF00FF00FF_000000FF00FF00FF));
}

static FOG_INLINE void sse2_zero_pixel_lo_1x1W(
  __m128i& dst0, const __m128i& src0)
{
  dst0 = _mm_and_si128(src0, FOG_SSE_GET_CONST_PI(FFFFFFFFFFFFFFFF_0000000000000000));
}

static FOG_INLINE void sse2_zero_pixel_hi_1x1W(
  __m128i& dst0, const __m128i& src0)
{
  dst0 = _mm_and_si128(src0, FOG_SSE_GET_CONST_PI(0000000000000000_FFFFFFFFFFFFFFFF));
}
...
static FOG_INLINE void sse2_fetch_rgb24_2x2W(__m128i& dst0, __m128i& dst1, const uint8_t* srcp)
{
  ...
  dst0 = _mm_or_si128(dst0, FOG_SSE_GET_CONST_PI(FF000000000000FF_FF000000000000FF));           // dst0 = [FF R1 G1 B1 R0 G0 B0 FF]
  dst1 = _mm_or_si128(dst1, FOG_SSE_GET_CONST_PI(FF000000000000FF_FF000000000000FF));           // dst1 = [FF R3 G3 B3 R2 G2 B2 FF]
...
static FOG_INLINE void sse2_fetch_bgr24_2x2W(__m128i& dst0, __m128i& dst1, const uint8_t* srcp)
{
  ...
  dst0 = _mm_or_si128(dst0, FOG_SSE_GET_CONST_PI(FF000000000000FF_FF000000000000FF));           // dst0 = [FF B1 G1 R1 B0 G0 R0 FF]
  dst1 = _mm_or_si128(dst1, FOG_SSE_GET_CONST_PI(FF000000000000FF_FF000000000000FF));           // dst1 = [FF B3 G3 R3 B2 G2 R2 FF]
...
static FOG_INLINE void sse2_vector_affine(__m128d& m_x_y, const double* m)
{
  ...
  __m128d m_sx_sy   = _mm_set_pd(m[4], m[0]);
  __m128d m_shx_shy = _mm_set_pd(m[1], m[3]);
  __m128d m_tx_ty   = _mm_loadu_pd(&m[6]);
...
{
  xy = _mm_add_pd(_mm_cvtepi32_pd(_mm_set_epi32(0, 0, y, x)), FOG_SSE_GET_CONST_PD(0_5_0_5));
}
...
static FOG_INLINE void sse2_vector_fetch_transformed(__m128d& fxfy, int x, int y, const double* m)
{
  ...
  fxfy = _mm_mul_pd(fxfy, FOG_SSE_GET_CONST_PD(65536_0_65536_0));
  fxfy = _mm_sub_pd(fxfy, FOG_SSE_GET_CONST_PD(32768_0_32768_0));
}
