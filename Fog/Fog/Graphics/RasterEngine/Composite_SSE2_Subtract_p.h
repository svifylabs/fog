  ...
  public CompositeBaseFuncsSSE2<CompositeSubtractSSE2>
{
    ...
    __m128i& dst0xmm, const __m128i& a0xmm, const __m128i& b0xmm)
  {
    ...
    x0xmm = _mm_xor_si128(x0xmm, FOG_SSE_GET_CONST_PI(000000FF000000FF_000000FF000000FF));
    y0xmm = _mm_xor_si128(y0xmm, FOG_SSE_GET_CONST_PI(000000FF000000FF_000000FF000000FF));
    ...
    __m128i& dst0xmm, const __m128i& a0xmm, const __m128i& b0xmm)
  {
    ...
    x0xmm = _mm_xor_si128(a0xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
    y0xmm = _mm_xor_si128(b0xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));

    sse2_muldiv255_1x1W(x0xmm, x0xmm, y0xmm);

    x0xmm = _mm_and_si128(x0xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
    x0xmm = _mm_xor_si128(x0xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
    ...
    __m128i& dst1xmm, const __m128i& a1xmm, const __m128i& b1xmm)
  {
    ...
    x0xmm = _mm_xor_si128(a0xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
    x1xmm = _mm_xor_si128(a1xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
    y0xmm = _mm_xor_si128(b0xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
    y1xmm = _mm_xor_si128(b1xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));

    sse2_muldiv255_2x2W(x0xmm, x0xmm, y0xmm, x1xmm, x1xmm, y1xmm);

    x0xmm = _mm_and_si128(a0xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
    x1xmm = _mm_and_si128(a1xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
    x0xmm = _mm_xor_si128(x0xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
    x1xmm = _mm_xor_si128(x1xmm, FOG_SSE_GET_CONST_PI(00FF000000000000_00FF000000000000));
