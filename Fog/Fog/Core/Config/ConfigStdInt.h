...
#ifndef _FOG_CORE_CONFIG_CONFIGSTDINT_H
#define _FOG_CORE_CONFIG_CONFIGSTDINT_H

#if !defined(FOG_IDE) && !defined(_FOG_CORE_CONFIG_CONFIG_H)
#error "Fog::Core::Config - ConfigStdInt.h can be only included by Fog/Core/Config/Config.h"
...
#endif // _FOG_CORE_CONFIG_CONFIGSTDINT_H
