...
//! @brief @ref FbEngine and @ref FbWindow event code.
enum FB_EVENT_CODE
{
  ...
  FB_EVENT_SHOW = 4,
  FB_EVENT_HIDE = 5,
  FB_EVENT_PARENT_HIDDEN = 6,

  FB_EVENT_ENABLE = 7,
  FB_EVENT_DISABLE = 8,
  FB_EVENT_PARENT_DISABLED = 9,

  FB_EVENT_GEOMETRY = 10,

  FB_EVENT_MINIMIZE = 11,
  FB_EVENT_MAXIMIZE = 12,
  FB_EVENT_RESTORE = 13,
  ...
  //! @brief Never dispatched, used internally.
  FB_EVENT_MOUSE_RECALC = 25,

  FB_EVENT_MOUSE_IN = 26,
  FB_EVENT_MOUSE_OUT = 27,
  FB_EVENT_MOUSE_MOVE = 28,

  FB_EVENT_MOUSE_DOWN = 29,
  FB_EVENT_MOUSE_UP = 30,

  FB_EVENT_MOUSE_CLICK = 31,
  FB_EVENT_MOUSE_DBL_CLICK = 32
};
...
enum FB_EVENT_FLAG
{
  ...
  FB_EVENT_FLAG_REJECT = 0x40000000,
  //! @brief Event was generated by the system.
  FB_EVENT_FLAG_SYSTEM = 0x80000000
};
