...
# define FOG_CONTROL87_BEGIN() \
  uint _control87_old = _control87(0x9001F, _MCW_DN | _MCW_EM | _MCW_RC)
# define FOG_CONTROL87_END() \
  _control87(_control87_old, _MCW_DN | _MCW_EM | _MCW_RC)
...
# define FOG_CONTROL87_BEGIN() \
  fenv_t _control87_env; \
  feholdexcept(&_control87_env)
# define FOG_CONTROL87_END() \
  fesetenv(&_control87_env)
