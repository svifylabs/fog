...
// [Guard]
#ifndef _FOG_CORE_KERNEL_DELEGATE_H
#define _FOG_CORE_KERNEL_DELEGATE_H
...
// [Fog::TypeInfo<>]
_FOG_TYPE_DECLARE_T1(Fog::Delegate0, class, RET, Fog::TYPE_CATEGORY_SIMPLE)
_FOG_TYPE_DECLARE_T2(Fog::Delegate1, class, T0, class, RET, Fog::TYPE_CATEGORY_SIMPLE)
_FOG_TYPE_DECLARE_T3(Fog::Delegate2, class, T0, class, T1, class, RET, Fog::TYPE_CATEGORY_SIMPLE)
_FOG_TYPE_DECLARE_T4(Fog::Delegate3, class, T0, class, T1, class, T2, class, RET, Fog::TYPE_CATEGORY_SIMPLE)
_FOG_TYPE_DECLARE_T5(Fog::Delegate4, class, T0, class, T1, class, T2, class, T3, class, RET, Fog::TYPE_CATEGORY_SIMPLE)
_FOG_TYPE_DECLARE_T6(Fog::Delegate5, class, T0, class, T1, class, T2, class, T3, class, T4, class, RET, Fog::TYPE_CATEGORY_SIMPLE)
_FOG_TYPE_DECLARE_T7(Fog::Delegate6, class, T0, class, T1, class, T2, class, T3, class, T4, class, T5, class, RET, Fog::TYPE_CATEGORY_SIMPLE)
_FOG_TYPE_DECLARE_T8(Fog::Delegate7, class, T0, class, T1, class, T2, class, T3, class, T4, class, T5, class, T6, class, RET, Fog::TYPE_CATEGORY_SIMPLE)
_FOG_TYPE_DECLARE_T9(Fog::Delegate8, class, T0, class, T1, class, T2, class, T3, class, T4, class, T5, class, T6, class, T7, class, RET, Fog::TYPE_CATEGORY_SIMPLE)

#endif // FOG_DOXYGEN

// [Guard]
#endif // _FOG_CORE_KERNEL_DELEGATE_H
