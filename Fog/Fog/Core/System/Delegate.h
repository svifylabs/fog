...
// CHANGES:
// ----------------------------------------------------------------------------
// - Renamed namespace fastdelegate -> none
// - Renamed namespace fastdelegate::detail -> Fog::DelegateDetail
// - Renamed Delegate -> DELEGATE
// - Renamed MakeDelegate -> DELEGATE
// - Renamed Delegate.empty -> Delegate.isEmpty
...
// - Changed #ifdef FASTDLGT_MICROSOFT_MFP -> #if defined(FASTDLGT_MICROSOFT_MFP) || defined(__clang__)
...
// ----------------------------------------------------------------------------
// ORIGINAL Delegate.h file:
// ----------------------------------------------------------------------------

// [Guard]
#ifndef _FOG_CORE_SYSTEM_DELEGATE_H
#define _FOG_CORE_SYSTEM_DELEGATE_H
...
//          * DELEGATE() global helper function added to simplify pass-by-value.
...
//             - The DELEGATEDECLARE workaround is no longer necessary.
//           - No more warning messages for VC6
//          * Less use of macros. Error messages should be more comprehensible.
//          * Added include guards
//          * Added Delegate::isEmpty() to test if invocation is safe (Thanks Neville Franks).
...
namespace DelegateDetail {  // we'll hide the implementation DelegateDetails in a nested namespace.
...
#define DELEGATEDECLARE(CLASSNAME)  class CLASSNAME;

// Prevent use of the static function hack with the DOS medium model.
#ifdef __MEDIUM__
#undef DELEGATE_USESTATICFUNCTIONHACK
#endif
...
protected:
  ...
  typedef void (DelegateDetail::GenericClass::*GenericMemFuncType)(); // arbitrary MFP.
  DelegateDetail::GenericClass *m_pthis;
...
#ifdef DELEGATE_GCC_BUG_8271  // At present, GCC doesn't recognize constness of MFPs in templates
  template < class X, class XMemFunc>
...
#endif // !defined(DELEGATE_USESTATICFUNCTIONHACK)
...
//N=0
template<class RetType=DelegateDetail::DefaultVoid>
class Delegate0 {
private:
  typedef typename DelegateDetail::DefaultVoidToVoid<RetType>::type DesiredRetType;
  typedef DesiredRetType (*StaticFunctionPtr)();
  typedef RetType (*UnvoidStaticFunctionPtr)();
  typedef RetType (DelegateDetail::GenericClass::*GenericMemFn)();
  typedef DelegateDetail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
...
public:
  ...
  Delegate0(Y *pthis, DesiredRetType (X::* function_to_bind)() ) {
    m_Closure.bindmemfunc(DelegateDetail::implicit_cast<X*>(pthis), function_to_bind); }
  template < class X, class Y >
  ...
  Delegate0(const Y *pthis, DesiredRetType (X::* function_to_bind)() const) {
    m_Closure.bindconstmemfunc(DelegateDetail::implicit_cast<const X*>(pthis), function_to_bind);  }
  template < class X, class Y >
...
public:
  ...
  const DelegateMemento & memento() { return m_Closure; }
...
//N=1
template<class Param1, class RetType=DelegateDetail::DefaultVoid>
class Delegate1 {
private:
  typedef typename DelegateDetail::DefaultVoidToVoid<RetType>::type DesiredRetType;
  typedef DesiredRetType (*StaticFunctionPtr)(Param1 p1);
  typedef RetType (*UnvoidStaticFunctionPtr)(Param1 p1);
  typedef RetType (DelegateDetail::GenericClass::*GenericMemFn)(Param1 p1);
  typedef DelegateDetail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
  ClosureType m_Closure;
public:
  // Typedefs to aid generic programming
...
//N=2
template<class Param1, class Param2, class RetType=DelegateDetail::DefaultVoid>
class Delegate2 {
private:
  typedef typename DelegateDetail::DefaultVoidToVoid<RetType>::type DesiredRetType;
  typedef DesiredRetType (*StaticFunctionPtr)(Param1 p1, Param2 p2);
  typedef RetType (*UnvoidStaticFunctionPtr)(Param1 p1, Param2 p2);
  typedef RetType (DelegateDetail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2);
  typedef DelegateDetail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
  ClosureType m_Closure;
public:
  // Typedefs to aid generic programming
...
//N=3
template<class Param1, class Param2, class Param3, class RetType=DelegateDetail::DefaultVoid>
class Delegate3 {
private:
  typedef typename DelegateDetail::DefaultVoidToVoid<RetType>::type DesiredRetType;
  typedef DesiredRetType (*StaticFunctionPtr)(Param1 p1, Param2 p2, Param3 p3);
  typedef RetType (*UnvoidStaticFunctionPtr)(Param1 p1, Param2 p2, Param3 p3);
  typedef RetType (DelegateDetail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3);
  typedef DelegateDetail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
  ClosureType m_Closure;
public:
  // Typedefs to aid generic programming
...
//N=4
template<class Param1, class Param2, class Param3, class Param4, class RetType=DelegateDetail::DefaultVoid>
class Delegate4 {
private:
  typedef typename DelegateDetail::DefaultVoidToVoid<RetType>::type DesiredRetType;
  ...
  typedef RetType (DelegateDetail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3, Param4 p4);
  typedef DelegateDetail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
  ClosureType m_Closure;
public:
  // Typedefs to aid generic programming
...
//N=5
template<class Param1, class Param2, class Param3, class Param4, class Param5, class RetType=DelegateDetail::DefaultVoid>
class Delegate5 {
private:
  typedef typename DelegateDetail::DefaultVoidToVoid<RetType>::type DesiredRetType;
  ...
  typedef RetType (DelegateDetail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5);
  typedef DelegateDetail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
  ClosureType m_Closure;
public:
  // Typedefs to aid generic programming
...
//N=6
template<class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class RetType=DelegateDetail::DefaultVoid>
class Delegate6 {
private:
  typedef typename DelegateDetail::DefaultVoidToVoid<RetType>::type DesiredRetType;
  ...
  typedef RetType (DelegateDetail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6);
  typedef DelegateDetail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
  ClosureType m_Closure;
public:
  // Typedefs to aid generic programming
...
//N=7
template<class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7, class RetType=DelegateDetail::DefaultVoid>
class Delegate7 {
private:
  typedef typename DelegateDetail::DefaultVoidToVoid<RetType>::type DesiredRetType;
  ...
  typedef RetType (DelegateDetail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7);
  typedef DelegateDetail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
  ClosureType m_Closure;
public:
  // Typedefs to aid generic programming
...
//N=8
template<class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7, class Param8, class RetType=DelegateDetail::DefaultVoid>
class Delegate8 {
private:
  typedef typename DelegateDetail::DefaultVoidToVoid<RetType>::type DesiredRetType;
  ...
  typedef RetType (DelegateDetail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8);
  typedef DelegateDetail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
  ClosureType m_Closure;
public:
  // Typedefs to aid generic programming
...
//
//      DELEGATE(&x, &X::func) returns a fastdelegate of the type
...
// Also declare overloads of a DELEGATE() global function to
...
#ifdef FASTDLGT_VC6
#define FASTDLGT_RETTYPE DelegateDetail::VoidToDefaultVoid<RetType>::type
#else
...
Delegate0<FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)()) {
  return Delegate0<FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class RetType>
Delegate0<FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)() const) {
  return Delegate0<FASTDLGT_RETTYPE>(x, func);
}

//N=1
template <class X, class Y, class Param1, class RetType>
Delegate1<Param1, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1)) {
  return Delegate1<Param1, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class RetType>
Delegate1<Param1, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1) const) {
  return Delegate1<Param1, FASTDLGT_RETTYPE>(x, func);
}

//N=2
template <class X, class Y, class Param1, class Param2, class RetType>
Delegate2<Param1, Param2, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2)) {
  return Delegate2<Param1, Param2, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class RetType>
Delegate2<Param1, Param2, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2) const) {
  return Delegate2<Param1, Param2, FASTDLGT_RETTYPE>(x, func);
}

//N=3
template <class X, class Y, class Param1, class Param2, class Param3, class RetType>
Delegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3)) {
  return Delegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class RetType>
Delegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3) const) {
  return Delegate3<Param1, Param2, Param3, FASTDLGT_RETTYPE>(x, func);
}

//N=4
template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class RetType>
Delegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) {
  return Delegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class RetType>
Delegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) const) {
  return Delegate4<Param1, Param2, Param3, Param4, FASTDLGT_RETTYPE>(x, func);
}

//N=5
template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class RetType>
Delegate5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)) {
  return Delegate5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class RetType>
Delegate5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) const) {
  return Delegate5<Param1, Param2, Param3, Param4, Param5, FASTDLGT_RETTYPE>(x, func);
}

//N=6
template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class RetType>
Delegate6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6)) {
  return Delegate6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class RetType>
Delegate6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) const) {
  return Delegate6<Param1, Param2, Param3, Param4, Param5, Param6, FASTDLGT_RETTYPE>(x, func);
}
...
Delegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7)) {
  return Delegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7, class RetType>
Delegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) const) {
  return Delegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE>(x, func);
}
...
Delegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8)) {
  return Delegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE>(x, func);
}

template <class X, class Y, class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7, class Param8, class RetType>
Delegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE> DELEGATE(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) const) {
  return Delegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE>(x, func);
}
...
// [Fog::TypeInfo<>]
_FOG_TYPEINFO_DECLARE_T1(Fog::Delegate0, class, RET, Fog::TYPEINFO_PRIMITIVE)
_FOG_TYPEINFO_DECLARE_T2(Fog::Delegate1, class, T0, class, RET, Fog::TYPEINFO_PRIMITIVE)
_FOG_TYPEINFO_DECLARE_T3(Fog::Delegate2, class, T0, class, T1, class, RET, Fog::TYPEINFO_PRIMITIVE)
_FOG_TYPEINFO_DECLARE_T4(Fog::Delegate3, class, T0, class, T1, class, T2, class, RET, Fog::TYPEINFO_PRIMITIVE)
_FOG_TYPEINFO_DECLARE_T5(Fog::Delegate4, class, T0, class, T1, class, T2, class, T3, class, RET, Fog::TYPEINFO_PRIMITIVE)
_FOG_TYPEINFO_DECLARE_T6(Fog::Delegate5, class, T0, class, T1, class, T2, class, T3, class, T4, class, RET, Fog::TYPEINFO_PRIMITIVE)
_FOG_TYPEINFO_DECLARE_T7(Fog::Delegate6, class, T0, class, T1, class, T2, class, T3, class, T4, class, T5, class, RET, Fog::TYPEINFO_PRIMITIVE)
_FOG_TYPEINFO_DECLARE_T8(Fog::Delegate7, class, T0, class, T1, class, T2, class, T3, class, T4, class, T5, class, T6, class, RET, Fog::TYPEINFO_PRIMITIVE)
_FOG_TYPEINFO_DECLARE_T9(Fog::Delegate8, class, T0, class, T1, class, T2, class, T3, class, T4, class, T5, class, T6, class, T7, class, RET, Fog::TYPEINFO_PRIMITIVE)

#endif // FOG_DOXYGEN

// [Guard]
#endif // _FOG_CORE_SYSTEM_DELEGATE_H
