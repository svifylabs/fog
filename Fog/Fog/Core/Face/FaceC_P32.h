...
// [Guard]
#ifndef _FOG_CORE_FACE_FACEC_P32_H
#define _FOG_CORE_FACE_FACEC_P32_H
...
static FOG_INLINE void p32Load2a(p32& dst0, const void* srcp) { dst0 = ((const uint16_t*)srcp)[0]; }
static FOG_INLINE void p32Load2u(p32& dst0, const void* srcp) { dst0 = ((const uint16_t*)srcp)[0]; }

static FOG_INLINE void p32Load2aBSwap(p32& dst0, const void* srcp) { dst0 = Memory::bswap16( ((const uint16_t*)srcp)[0] ); }
static FOG_INLINE void p32Load2uBSwap(p32& dst0, const void* srcp) { dst0 = Memory::bswap16( ((const uint16_t*)srcp)[0] ); }

static FOG_INLINE void p32Store2a(void* dstp, const p32& src0) { ((uint16_t*)dstp)[0] = (uint16_t)(src0); }
static FOG_INLINE void p32Store2u(void* dstp, const p32& src0) { ((uint16_t*)dstp)[0] = (uint16_t)(src0); }

static FOG_INLINE void p32Store2aBSwap(void* dstp, const p32& src0) { ((uint16_t*)dstp)[0] = Memory::bswap16( (uint16_t)(src0) ); }
static FOG_INLINE void p32Store2uBSwap(void* dstp, const p32& src0) { ((uint16_t*)dstp)[0] = Memory::bswap16( (uint16_t)(src0) ); }

static FOG_INLINE void p32Load4a(p32& dst0, const void* srcp) { dst0 = ((const uint32_t*)srcp)[0]; }
static FOG_INLINE void p32Load4u(p32& dst0, const void* srcp) { dst0 = ((const uint32_t*)srcp)[0]; }

static FOG_INLINE void p32Load4aBSwap(p32& dst0, const void* srcp) { dst0 = Memory::bswap32( ((const uint32_t*)srcp)[0] ); }
static FOG_INLINE void p32Load4uBSwap(p32& dst0, const void* srcp) { dst0 = Memory::bswap32( ((const uint32_t*)srcp)[0] ); }

static FOG_INLINE void p32Store4a(void* dstp, const p32& src0) { ((uint32_t*)dstp)[0] = (uint32_t)(src0); }
static FOG_INLINE void p32Store4u(void* dstp, const p32& src0) { ((uint32_t*)dstp)[0] = (uint32_t)(src0); }

static FOG_INLINE void p32Store4aBSwap(void* dstp, const p32& src0) { ((uint32_t*)dstp)[0] = Memory::bswap32( (uint32_t)(src0) ); }
static FOG_INLINE void p32Store4uBSwap(void* dstp, const p32& src0) { ((uint32_t*)dstp)[0] = Memory::bswap32( (uint32_t)(src0) ); }

static FOG_INLINE void p32Load3b(p32& dst0, const void* srcp)
{
...
static FOG_INLINE void p32Load3bBSwap(p32& dst0, const void* srcp)
{
  const uint8_t* src8 = reinterpret_cast<const uint8_t*>(srcp);
...
static FOG_INLINE void p32Store3b(void* dstp, const p32& src0)
{
...
static FOG_INLINE void p32Store3bBSwap(void* dstp, const p32& src0)
{
  uint8_t* dst8 = reinterpret_cast<uint8_t*>(dstp);
...
static FOG_INLINE void p32Load8a(p32& dst0Lo, p32& dst0Hi, const void* srcp)
{
#if FOG_BYTE_ORDER == FOG_LITTLE_ENDIAN
  // [7 6 5 4|3 2 1 0]
...
static FOG_INLINE void p32Load8u(p32& dst0Lo, p32& dst0Hi, const void* srcp)
{
#if FOG_BYTE_ORDER == FOG_LITTLE_ENDIAN
  // [7 6 5 4|3 2 1 0]
  dst0Lo = ((const uint32_t*)srcp)[0];
...
static FOG_INLINE void p32Store8a(void* dstp, const p32& src0Lo, const p32& src0Hi)
{
#if FOG_BYTE_ORDER == FOG_LITTLE_ENDIAN
  // [7 6 5 4|3 2 1 0]
...
static FOG_INLINE void p32Store8u(void* dstp, const p32& src0Lo, const p32& src0Hi)
{
#if FOG_BYTE_ORDER == FOG_LITTLE_ENDIAN
  // [7 6 5 4|3 2 1 0]
  ((uint32_t*)dstp)[0] = src0Lo;
...
// [Guard]
#endif // _FOG_CORE_FACE_FACEC_P32_H
