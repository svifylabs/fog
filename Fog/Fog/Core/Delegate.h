...
// [Guard]
#ifndef _FOG_CORE_DELEGATE_H
#define _FOG_CORE_DELEGATE_H
...
// [Fog::TypeInfo<>]
FOG_DECLARE_TYPEINFO_TEMPLATE1(Fog::Delegate0, class, RET, Fog::PrimitiveType)
FOG_DECLARE_TYPEINFO_TEMPLATE2(Fog::Delegate1, class, T0, class, RET, Fog::PrimitiveType)
FOG_DECLARE_TYPEINFO_TEMPLATE3(Fog::Delegate2, class, T0, class, T1, class, RET, Fog::PrimitiveType)
FOG_DECLARE_TYPEINFO_TEMPLATE4(Fog::Delegate3, class, T0, class, T1, class, T2, class, RET, Fog::PrimitiveType)
FOG_DECLARE_TYPEINFO_TEMPLATE5(Fog::Delegate4, class, T0, class, T1, class, T2, class, T3, class, RET, Fog::PrimitiveType)
FOG_DECLARE_TYPEINFO_TEMPLATE6(Fog::Delegate5, class, T0, class, T1, class, T2, class, T3, class, T4, class, RET, Fog::PrimitiveType)
FOG_DECLARE_TYPEINFO_TEMPLATE7(Fog::Delegate6, class, T0, class, T1, class, T2, class, T3, class, T4, class, T5, class, RET, Fog::PrimitiveType)
FOG_DECLARE_TYPEINFO_TEMPLATE8(Fog::Delegate7, class, T0, class, T1, class, T2, class, T3, class, T4, class, T5, class, T6, class, RET, Fog::PrimitiveType)
FOG_DECLARE_TYPEINFO_TEMPLATE9(Fog::Delegate8, class, T0, class, T1, class, T2, class, T3, class, T4, class, T5, class, T6, class, T7, class, RET, Fog::PrimitiveType)
