...
// [Guard]
#ifndef _FOG_G2D_OS_WINGDIPLUS_H
#define _FOG_G2D_OS_WINGDIPLUS_H
...
//! @brief Windows GdiPlus library interface.
//!
...
struct FOG_API WinGdiPlus
{
  ...
  union
  {
    struct
    {
      ...
      GpStatus (FOG_STDCALL* _GdipDrawImageRectI)(GpGraphics *graphics, GpImage *image, int x, int y, int width, int height);
...
// [Guard]
#endif // _FOG_G2D_OS_WINGDIPLUS_H
