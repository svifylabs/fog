...
struct FOG_NO_EXPORT Region
{
  ...
  FOG_INLINE Region()
  {
    fog_api.region_ctor(this);
  }

  FOG_INLINE Region(const Region& other)
  {
    fog_api.region_ctorRegion(this, &other);
  }

  explicit FOG_INLINE Region(const BoxI& box)
  {
    fog_api.region_ctorBox(this, &box);
  }

  explicit FOG_INLINE Region(const RectI& rect)
  {
    fog_api.region_ctorRect(this, &rect);
  }
  ...
  FOG_INLINE err_t _detach() { return fog_api.region_detach(this); }
  ...
  FOG_INLINE uint32_t getType() const { return fog_api.region_getType(this); }
  ...
  FOG_INLINE bool isInfinite() const { return _d == fog_api.region_oInfinite->_d; }
  ...
  {
    return fog_api.region_clear(this);
  }
  ...
  {
    return fog_api.region_reset(this);
  }
  ...
  {
    return fog_api.region_combineRegionRegion(this, this, &region, combineOp);
  }

  FOG_INLINE err_t combine(const BoxI& box, uint32_t combineOp)
  {
    return fog_api.region_combineRegionBox(this, this, &box, combineOp);
  }
  ...
  {
    return fog_api.region_translate(this, this, &pt);
  }
  ...
  {
    return fog_api.region_translateAndClip(this, this, &pt, &clipBox);
  }
  ...
  {
    return fog_api.region_intersectAndClip(this, this, &region, &clipBox);
  }
  ...
  {
    return fog_api.region_hitTestPoint(this, &pt);
  }
  ...
  {
    return fog_api.region_hitTestBox(this, &box);
  }

  FOG_INLINE uint32_t hitTest(const RectI& rect) const
  {
    return fog_api.region_hitTestRect(this, &rect);
  }
  ...
  {
    return fog_api.region_eq(this, &other);
  }
  ...
  FOG_INLINE Region& operator=(const Region& other) { fog_api.region_setRegion(this, &other); return *this; }
  FOG_INLINE Region& operator=(const BoxI& box) { fog_api.region_setBox(this, &box); return *this; }
  FOG_INLINE Region& operator=(const RectI& rect) { fog_api.region_setRect(this, &rect); return *this; }
  ...
  FOG_INLINE bool operator==(const Region& other) const { return  fog_api.region_eq(this, &other); }
  FOG_INLINE bool operator!=(const Region& other) const { return !fog_api.region_eq(this, &other); }
  ...
  {
    return fog_api.region_eq(a, b);
  }

  static FOG_INLINE EqFunc getEqFunc()
  {
    return (EqFunc)fog_api.region_eq;
  }
  ...
  {
    return fog_api.region_combineRegionRegion(&dst, &a, &b, combineOp);
  }

  static FOG_INLINE err_t combine(Region& dst, const Region& a, const BoxI& b, uint32_t combineOp)
  {
    return fog_api.region_combineRegionBox(&dst, &a, &b, combineOp);
  }
  ...
  {
    return fog_api.region_combineBoxRegion(&dst, &a, &b, combineOp);
  }
  ...
  {
    return fog_api.region_combineBoxBox(&dst, &a, &b, combineOp);
  }
  ...
  static FOG_INLINE err_t combine(Region& dst, const RectI& a, const RectI& b, uint32_t combineOp)
  {
    BoxI aBox(a);
    BoxI bBox(b);
    return fog_api.region_combineBoxBox(&dst, &aBox, &bBox, combineOp);
  }
  ...
  {
    return fog_api.region_translate(&dst, &src, &pt);
  }
  ...
  {
    return fog_api.region_intersectAndClip(&dst, &a, &b, &clipBox);
  }
