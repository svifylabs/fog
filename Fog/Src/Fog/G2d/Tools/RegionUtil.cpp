...
{
  fog_api.regionutil_getClosestBox = RegionUtil_getClosestBox;
  fog_api.regionutil_isBoxListSorted = RegionUtil_isBoxListSorted;
  fog_api.regionutil_isRectListSorted = RegionUtil_isRectListSorted;
}
