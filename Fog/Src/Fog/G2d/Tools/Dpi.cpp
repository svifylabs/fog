...
{
  fog_api.dpi_setDpiEmEx(self, 72.0f, 12.0f, 6.0f);
}
...
FOG_NO_EXPORT void Dpi_init(void)
{
  ...
  fog_api.dpi_reset = Dpi_reset;
  fog_api.dpi_setDpi = Dpi_setDpi;
  fog_api.dpi_setDpiEmEx = Dpi_setDpiEmEx;
  fog_api.dpi_copy = Dpi_copy;
}
