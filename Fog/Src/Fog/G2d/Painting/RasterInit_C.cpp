...
//convert.from_argb64[RASTER_FORMAT_I8                 ];
  ...
  */
...
#if defined(FOG_RASTER_INIT_C)
  {
    ...
    FOG_RASTER_INIT(vblit_line[IMAGE_FORMAT_XRGB32   ], RasterOps_C::Convert::fill_8);
    FOG_RASTER_INIT(vblit_line[IMAGE_FORMAT_RGB24    ], RasterOps_C::Convert::fill_8);
    ...
    FOG_RASTER_INIT(vblit_line[IMAGE_FORMAT_RGB48    ], RasterOps_C::Convert::fill_8);
