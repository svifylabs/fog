...
struct FOG_NO_EXPORT PixelPRGB64
{
  ...
  static FOG_INLINE void p32LoadPixelA8(uint32_t& dst0p, const void* src)
  {
    ...
    Acc::p32Load1b(dst0p, static_cast<const uint8_t*>(src) + PIXEL_ARGB64_POS_A * 2 + 1);
#else
    Acc::p32Load1b(dst0p, static_cast<const uint8_t*>(src) + PIXEL_ARGB64_POS_A * 2 + 0);
#endif
  }
...
struct AccessPRGB32
{
  ...
  {
    uint32_t t0;
    Acc::p32FillPBB3(t0, src0);
    Acc::p32Store4a(dstp, t0);
  }
...
struct AccessRGB16_555
{
  ...
  static FOG_INLINE void p32LoadPRGB32(uint32_t& dst0, const void* srcp)
  {
    Acc::p32Load2a(dst0, srcp);
    Acc::p32FRGB32FromRGB16_555(dst0, dst0);
  }

  static FOG_INLINE void p32LoadXRGB32(uint32_t& dst0, const void* srcp)
  {
    Acc::p32Load2a(dst0, srcp);
    Acc::p32ZRGB32FromRGB16_555(dst0, dst0);
  }
  ...
  {
    uint32_t t0;
    Acc::p32RGB16_555FromXRGB32(t0, src0);
    Acc::p32Store2a(dstp, t0);
  }
...
struct AccessRGB16_565
{
  ...
  {
    Acc::p32Load2a(dst0, srcp);
    Acc::p32FRGB32FromRGB16_565(dst0, dst0);
  }

  static FOG_INLINE void p32LoadXRGB32(uint32_t& dst0, const void* srcp)
  {
    Acc::p32Load2a(dst0, srcp);
    Acc::p32ZRGB32FromRGB16_565(dst0, dst0);
  }
  ...
  {
    uint32_t t0;
    Acc::p32RGB16_565FromXRGB32(t0, src0);
    Acc::p32Store2a(dstp, t0);
  }
...
struct AccessPRGB64
{
  ...
  static FOG_INLINE void p32LoadPRGB32(uint32_t& dst0, const void* srcp)
  {
    ...
    Acc::p32Load8a(src0p_10, src0p_32, srcp);
    Acc::p32ARGB32FromARGB64_1032(dst0, src0p_10, src0p_32);
  }
  ...
  static FOG_INLINE void p32LoadXRGB32(uint32_t& dst0, const void* srcp)
  {
    ...
    Acc::p32Load8a(src0p_10, src0p_32, srcp);
    Acc::p32ZRGB32FromARGB64_1032(dst0, src0p_10, src0p_32);
  }
  ...
  static FOG_INLINE void p32StorePRGB32(void* dstp, const uint32_t& src0)
  {
    ...
    Acc::p32PRGB64FromPRGB32(src0p_10, src0p_32, src0);
    Acc::p32Store8a(dstp, src0p_10, src0p_32);
  }
  ...
  static FOG_INLINE void p32StoreXRGB32(void* dstp, const uint32_t& src0)
  {
    ...
    Acc::p32FRGB64FromXRGB32(src0p_10, src0p_32, src0);
    Acc::p32Store8a(dstp, src0p_10, src0p_32);
  }
  ...
  static FOG_INLINE void p32StoreZRGB32(void* dstp, const uint32_t& src0)
  {
    ...
    Acc::p32FRGB64FromZRGB32(src0p_10, src0p_32, src0);
    Acc::p32Store8a(dstp, src0p_10, src0p_32);
  }
  ...
  {
    Acc::p32Load8a(dst0_10, dst0_32, srcp);
  }
  ...
  {
    Acc::p32Store8a(dstp, src0_10, src0_32);
  }
  ...
  static FOG_INLINE void p32StoreXRGB64(void* dstp, const uint32_t& src0_10, const uint32_t& src0_32)
  {
    ...
    Acc::p32FillPWW1(src0_F2, src0_32);
    Acc::p32Store8a(dstp, src0_10, src0_F2);
  }
};
...
struct AccessRGB48
{
  ...
  static FOG_INLINE void p32LoadPRGB32(uint32_t& dst0, const void* srcp)
  {
    Acc::p32RGB48LoadToFRGB32(dst0, srcp);
  }

  static FOG_INLINE void p32LoadXRGB32(uint32_t& dst0, const void* srcp)
  {
    Acc::p32RGB48LoadToZRGB32(dst0, srcp);
  }
  ...
  static FOG_INLINE void p32StorePRGB32(void* dstp, const uint32_t& src0)
  {
    Acc::p32RGB48StoreFromXRGB32(dstp, src0);
  }
  ...
  static FOG_INLINE void p32LoadPRGB64(uint32_t& dst0_10, uint32_t& dst0_32, const void* srcp)
  {
    ...
    Acc::p32RGB48Load(src0_r, src0_g, src0_b, srcp);
    dst0_10 = _FOG_ACC_COMBINE_2(src0_b, src0_g << 16);
    dst0_32 = _FOG_ACC_COMBINE_2(src0_r, 0xFFFF0000);
  }
