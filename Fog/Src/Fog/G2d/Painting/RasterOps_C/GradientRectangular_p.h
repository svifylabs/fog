...
// [Guard]
#ifndef _FOG_G2D_PAINTING_RASTEROPS_C_GRADIENTRECTANGULAR_P_H
#define _FOG_G2D_PAINTING_RASTEROPS_C_GRADIENTRECTANGULAR_P_H
...
// ============================================================================
// [Fog::RasterOps_C - PGradientRectangular]
// ============================================================================
...
struct FOG_NO_EXPORT PGradientRectangular
{
    ...
    uint32_t gradientQuality)
  {
    ...
    if (inv.getType() <= TRANSFORM_TYPE_AFFINE)
    {
      ...
      ctx->_fetch = _api_raster.gradient.rectangular.fetch_simple_nearest[srcFormat][spread];
    ...
    else
    {
      ...
      ctx->_destroy = PGradientBase::destroy;
      ctx->_fetch = _api_raster.gradient.rectangular.fetch_proj_nearest[srcFormat][spread];
      ctx->_skip = skip_proj;
...
// [Guard]
#endif // _FOG_G2D_PAINTING_RASTEROPS_C_GRADIENTRECTANGULAR_P_H
