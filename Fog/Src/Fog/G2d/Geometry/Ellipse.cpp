...
{
  fog_api.ellipsef_getBoundingBox = EllipseT_getBoundingBox<float>;
  fog_api.ellipsed_getBoundingBox = EllipseT_getBoundingBox<double>;

  fog_api.ellipsef_hitTest = EllipseT_hitTest<float>;
  fog_api.ellipsed_hitTest = EllipseT_hitTest<double>;

  fog_api.ellipsef_toCSpline = EllipseT_toCSpline<float>;
  fog_api.ellipsed_toCSpline = EllipseT_toCSpline<double>;
}
