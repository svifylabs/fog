...
_FOG_TYPE_DECLARE(Fog::PointArrayI             , C(SIMPLE )               | F(NO_CMP )            )
_FOG_TYPE_DECLARE(Fog::PointArrayF             , C(SIMPLE )               | F(NO_CMP )            )
_FOG_TYPE_DECLARE(Fog::PointArrayD             , C(SIMPLE )               | F(NO_CMP )            )
...
_FOG_TYPE_DECLARE(Fog::RectArrayI              , C(SIMPLE )               | F(NO_CMP )            )
_FOG_TYPE_DECLARE(Fog::RectArrayF              , C(SIMPLE )               | F(NO_CMP )            )
_FOG_TYPE_DECLARE(Fog::RectArrayD              , C(SIMPLE )               | F(NO_CMP )            )
...
_FOG_TYPE_DECLARE(Fog::ShapeF                  , C(SIMPLE )               | F(NO_CMP )            )
_FOG_TYPE_DECLARE(Fog::ShapeD                  , C(SIMPLE )               | F(NO_CMP )            )
...
_FOG_TYPE_DECLARE(Fog::FaceCollection          , C(MOVABLE) | F(IMPLICIT) | F(NO_CMP )            )
_FOG_TYPE_DECLARE(Fog::FaceDesignMetrics       , C(SIMPLE )               | F(NO_CMP )            )
