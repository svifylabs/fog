...
struct FOG_NO_EXPORT Api
{
  ...
  FOG_CAPI_STATIC(uint32_t, charutil_getIso15924FromTextScript)(uint32_t script);
  FOG_CAPI_STATIC(uint32_t, charutil_getTextScriptFromIso15924)(uint32_t iso15924);

  FOG_CAPI_STATIC(uint32_t, charutil_decomposeUcs2To16)(uint16_t c, uint16_t* dst16, uint32_t* decompositionType);
  FOG_CAPI_STATIC(uint32_t, charutil_decomposeUcs2To32)(uint16_t c, uint32_t* dst32, uint32_t* decompositionType);

  FOG_CAPI_STATIC(uint32_t, charutil_decomposeUcs4To16)(uint32_t c, uint16_t* dst16, uint32_t* decompositionType);
  FOG_CAPI_STATIC(uint32_t, charutil_decomposeUcs4To32)(uint32_t c, uint32_t* dst32, uint32_t* decompositionType);

  FOG_CAPI_STATIC(uint16_t, charutil_composeUcs2)(uint16_t a, uint16_t b);
  FOG_CAPI_STATIC(uint32_t, charutil_composeUcs4)(uint32_t a, uint32_t b);
  ...
  FOG_CAPI_METHOD(bool, stringw_isCanonical)(const StringW* self, const Range* range, uint32_t version, size_t* where);
  FOG_CAPI_METHOD(err_t, stringw_makeCanonical)(StringW* self, const Range* range, uint32_t version);
  FOG_CAPI_METHOD(bool, stringw_isNormalized)(const StringW* self, const Range* range, uint32_t normForm, uint32_t version, size_t* where);
  FOG_CAPI_METHOD(uint32_t, stringw_quickCheck)(const StringW* self, const Range* range, uint32_t normForm, uint32_t version, size_t* where);
  FOG_CAPI_METHOD(err_t, stringw_normalize)(StringW* self, const Range* range, uint32_t normForm, uint32_t version);
  ...
  FOG_CAPI_STATIC(bool, stringutil_isCanonical)(const CharW* data, size_t length, uint32_t version, size_t* where);
  FOG_CAPI_STATIC(void, stringutil_makeCanonical)(CharW* data, size_t length, uint32_t version, size_t from);

  FOG_CAPI_STATIC(bool, stringutil_isNormalized)(const CharW* data, size_t length, uint32_t normForm, uint32_t version, size_t* where);
  FOG_CAPI_STATIC(uint32_t, stringutil_quickCheck)(const CharW* data, size_t length, uint32_t normForm, uint32_t version, size_t* where);
  ...
  FOG_CAPI_METHOD(err_t, faceinfo_setMetrics)(FaceInfo* self, const FaceInfoMetrics* metrics);
