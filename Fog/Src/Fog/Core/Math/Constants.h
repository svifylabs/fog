...
// +----------+---------------------------------------------------------------+
// |1/2       | 0.5                                                           |
// |1/3       | 0.333333333333333333333333333333333333333333333333333333333334|
// |1/4       | 0.25                                                          |
// |1/5       | 0.20                                                          |
// |1/6       | 0.166666666666666666666666666666666666666666666666666666666667|
// |1/7       | 0.142857142857142857142857142857142857142857142857142857142857|
// |1/8       | 0.125                                                         |
// |1/9       | 0.111111111111111111111111111111111111111111111111111111111111|
// |1/10      | 0.1                                                           |
// |1/255     | 0.003921568627450980392156862745098039215686274509803921568627|
// |1/256     | 0.003906250000000000000000000000000000000000000000000000000000|
// |1/65535   | 0.000015259021896696421759365224689097428854810406652933546960|
// |1/65536   | 0.000015258789062500000000000000000000000000000000000000000000|
// +----------+---------------------------------------------------------------+
...
//! @brief sqrt(0.5).
static const double MATH_SQRT_HALF      = 0.707107;
...
//! @brief "1/6".
static const double MATH_1_DIV_7        = 0.142857142857142857143;
//! @brief "1/6".
static const double MATH_1_DIV_8        = 0.125;
//! @brief "1/6".
static const double MATH_1_DIV_9        = 0.111111111111111111112;
...
//! @brief "1/255".
static const double MATH_1_DIV_255      = 0.003921568627450980392;
//! @brief "1/256".
static const double MATH_1_DIV_256      = 0.00390625;

//! @brief "1/65535".
static const double MATH_1_DIV_65535    = 0.000015259021896696422;
//! @brief "1/65536".
static const double MATH_1_DIV_65536    = 0.0000152587890625;
