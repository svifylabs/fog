...
#include <Fog/Graphics/ImageIO/ImageIO_GdiPlus_p.h>
...
static uint32_t GdiPlus_fogFormatFromGpFormat(GpPixelFormat gpFormat)
{
  switch (gpFormat)
  {
    ...
    case GpPixelFormat16bppRGB565:
      return IMAGE_FORMAT_XRGB32;

    case GpPixelFormat16bppARGB1555:
      return IMAGE_FORMAT_ARGB32;
...
static GpPixelFormat gdiPlus_gpFormatFromFogFormat(uint32_t fogFormat)
{
  switch (fogFormat)
  {
    case IMAGE_FORMAT_PRGB32: return GpPixelFormat32bppPARGB;
    case IMAGE_FORMAT_ARGB32: return GpPixelFormat32bppARGB;
    case IMAGE_FORMAT_XRGB32: return GpPixelFormat32bppRGB;
    case IMAGE_FORMAT_A8    : return GpPixelFormat8bppIndexed;
...
FOG_DEFINE_GUID(GpEncoderQuality, 0x1d5be4b5, 0xfa4a, 0x452d, 0x9c, 0xdd, 0x5d, 0xb3, 0x51, 0x05, 0xe7, 0xeb);
...
err_t GdiPlusDecoderDevice::readHeader()
{
  ...
  _depth = Image::getDepthFromFormat(_format);
