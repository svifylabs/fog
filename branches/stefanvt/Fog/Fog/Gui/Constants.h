...
enum LAYOUT_POLICY_FLAGS {
  ...
  LAYOUT_EXPANDING_WIDTH = (1<<0),  
  LAYOUT_SHRINKING_WIDTH = (1<<1),
  LAYOUT_GROWING_WIDTH = (1<<2),
  LAYOUT_IGNORE_WIDTH  = (1<<3),

  LAYOUT_EXPANDING_HEIGHT = (1<<4),
  LAYOUT_SHRINKING_HEIGHT = (1<<5),
  LAYOUT_GROWING_HEIGHT = (1<<6),
...
enum LAYOUT_POLICY
{
  ...
  LAYOUT_POLICY_HEIGHT_PREFERRED = LAYOUT_GROWING_HEIGHT|LAYOUT_SHRINKING_HEIGHT,
  LAYOUT_POLICY_HEIGHT_MINIMUM_EXPANDING = LAYOUT_GROWING_HEIGHT|LAYOUT_EXPANDING_HEIGHT,
  LAYOUT_POLICY_HEIGHT_EXPANDING = LAYOUT_GROWING_HEIGHT|LAYOUT_EXPANDING_HEIGHT|LAYOUT_SHRINKING_HEIGHT,
  LAYOUT_POLICY_HEIGHT_IGNORED = LAYOUT_GROWING_HEIGHT|LAYOUT_IGNORE_HEIGHT|LAYOUT_SHRINKING_HEIGHT,

  LAYOUT_POLICY_WIDTH_MINIMUM = LAYOUT_EXPANDING_WIDTH,
  LAYOUT_POLICY_WIDTH_MAXIMUM = LAYOUT_SHRINKING_WIDTH,
  LAYOUT_POLICY_WIDTH_PREFERRED = LAYOUT_GROWING_WIDTH|LAYOUT_SHRINKING_WIDTH,
...
enum ALIGNMENT
{
  ALIGNMENT_LEFT = 0x001,     //Aligns with the left edge.
  ALIGNMENT_RIGHT = 0x002,    //Aligns with the right edge.
  ALIGNMENT_HCENTER = 0x004,  //Centers horizontally in the available space. 
